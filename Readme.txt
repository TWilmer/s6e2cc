...
This is a project template for S6E2CCxJ (with x = flash size). It includes some
...
--------------
 ...
 | + svd                                     SVD files
 | | |-> s6e2ccxj.sfr                        precompiled SVD file
 | | |-> s6e2ccxj.svd                        SVD file defined in CMSIS
 |
 ...
 | |-> gpio_s6e2ccxj.h                       GPIO macros used for GPIOs
 | |-> S6E2CCxJ.h                            MCU Headerfile
 ...
 | | |-> s6e2ccxj_template.uvprojx           ARM/µVision IDE project/workspace file
 | | |-> startup_s6e2cc.s                    Startup file for ARM/µVision
 | | + output                                output folder
 | | | + release                             output folder for release build
 | | | | |-> s6e2ccxj_template.srec          firmware file
 | | | |
 ...
 | | |-> s6e2ccxj_template.eww               IAR project/workspace file
 ...
 | | |-> s6e2ccxj_template.xjrf              iSYSTEM project/workspace file
...
--------------------------------------------------------------------------------
    ...
    s6e2ccxj             = MCU name, x = flash size
    s6e2cc               = MCU series name
    s6e2ccxj_template    = Project name
