...
2015-01-30  0.1    DHo     6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
This example demonstrates how to use lcd cl010.
...
Usage Procedure:
===============================================================================================
1) Check LCD drive power mode. 
   if supplied by LCD booster, please change below macro define in cl010_config.h
   change '#define LCD_BOOSTER_ENABLE FALSE' to '#define LCD_BOOSTER_ENABLE TRUE'   
2) Start debug
3) run
4) Watch lcd
