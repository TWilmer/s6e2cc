...
1) GND and VCC connect between board and DC power supply, then turn on.
   Voltage of power supply is adjusted more than 3.0V
2) Rebuild and run the program.
3) Decrease voltage gradually, then P3F truns to low when VCC is lower than 2.7V. And 
   P3F turns to high when VCC is lower than 1.8V.
