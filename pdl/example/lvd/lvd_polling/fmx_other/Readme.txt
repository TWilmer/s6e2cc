...
2014-12-26  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
Sample program for LVD (unuse interrupt).
...
Usage Procedure:
===============================================================================================
1) GND and VCC connect between board and DC power supply, then turn on.
   Voltage of power supply is adjusted more than 3.0V(FM0+/FM3)/3.0V(FM4 type1/2)/3.1V(FM4 other types)
2) Rebuild and run the program.
3) Decrease voltage gradually, then P3F turns to low when voltage is vicinity of 
3.0V(FM0+/FM3)/3.0V(FM4 type1/2)/3.1V(FM4 other types).
