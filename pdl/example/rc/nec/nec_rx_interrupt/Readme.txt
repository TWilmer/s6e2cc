...
===============================================================================================
Sample program for RC NEC receive interrupt operation.
...
Assistance tool:
---------------------
TV Remote Control unit(NEC mode) 
infrared receive board
...
2) connect the 'CEC0 pin, GND and VCC'with the infrared receive board
3) press the 'TV remote control unit' key, and watch the IO terminal.
