...
#ifdef DEBUG_PRINT
    printf("==================================================\n");
    printf("NEC detect the Start Bit \n");
    printf("==================================================\n");
#endif
}
...
/*!
 ******************************************************************************
 ** \brief Repeat code interrupt handler
 **
 ** \param None
 **
 ** \retval None
 ...
 ******************************************************************************
 */
static void RepeatCodeIrqCallback(void)
{
#ifdef DEBUG_PRINT
    printf("==================================================\n");
    printf("NEC detect the Repeat Code \n");
    printf("==================================================\n");
#endif
}
/**
...
static void InitNec(void)
{
    ...
    stc_rc_rx_nec_irq_en_t stcRcRxNecIrqEn;
    stc_rc_rx_nec_irq_cb_t stcRcRxNecIrqCallBack;
    // Clear structures
    PDL_ZERO_STRUCT(stcRcNecConfig);
    PDL_ZERO_STRUCT(stcRcRxNecIrqEn);
    PDL_ZERO_STRUCT(stcRcRxNecIrqCallBack);
    
     //configure Sircs interrupt mode
    stcRcRxNecIrqEn.bRcRxNecRepeatCodeIrq = TRUE;               ///< enable zero match interrupt
    stcRcRxNecIrqEn.bRcRxNecStartIrq = TRUE;                    ///< enable start bit detection interrupt
    stcRcRxNecIrqEn.bRcRxNecRepeatCodeIrq = TRUE;               ///< enable repeak match interrupt
    
    //configure callback function of Sircs
    stcRcRxNecIrqCallBack.pfnRcRxNecStartIrqCb = StartBitIrqCallback;   
    stcRcRxNecIrqCallBack.pfnRcRxNecCntOvfIrqCb = CountOverIrqCallback;   
    stcRcRxNecIrqCallBack.pfnRcRxNecRepeatCodeIrqCb = RepeatCodeIrqCallback;
    ...
    stcRcNecConfig.pstcIrqEn = &stcRcRxNecIrqEn;
    stcRcNecConfig.pstcIrqCb = &stcRcRxNecIrqCallBack;
    stcRcNecConfig.bTouchNvic = TRUE;
...
#ifdef DEBUG_PRINT
    printf("==================================================\n");
    printf("NEC tx interrupt Example Program Start \n");
    printf("==================================================\n");
#endif
    while(1)
    {
