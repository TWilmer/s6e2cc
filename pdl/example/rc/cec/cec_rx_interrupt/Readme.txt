...
2015-01-21  0.2    KX        6.50.1    5.20  Modify with Universal PDL
===============================================================================================
Function description:
===============================================================================================
Sample program for RC receive interrupt operation.
...
Usage Procedure:
===============================================================================================
1) Open 'cec_tx_interrupt' or 'cec_tx_polling' folder for get CEC transmit program 
2) Rebuild and download it into one 'MCU evaluation board'.
3) Rebuild and run 'cec_rx_interrupt' program into the other 'MCU evaluation board'.
4) Add a 10K pull-up resistance on CEC0 pin, and connect two boards CEC0 pin and GND.
5) press the key with transmit board, and watch the 'IO terminal' out in receive board. 
