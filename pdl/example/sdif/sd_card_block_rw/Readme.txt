...
2015-03-12  0.1    RZh         6.50.1  4.50  first version
================================================================================
Function description:
================================================================================
Write 100MB data from SD card sector 0 and read back , check if it writes 
correct.
...
================================================================================
1) Start the project
2) insert a SD/eMMC card. (The data will be lost,please backup if necessary)
3) the LCD is blinking, means it is in test.
4) when the LED is not blinking, check the LED on board, it shows:
    GREEN       :pass
    RED/BLUE    :fail
