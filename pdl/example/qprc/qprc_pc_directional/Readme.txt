...
2014-12-22  0.1    DHo          6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
Demo the Mode 3 of Position counter of QPRC.
...
2) Check RTO00_0, AIN0_0, RTO01_0 and BIN0_0 pins.
   If pins are no conflict, connect VCC with AIN0_0, RTO00_0 with BIN0_0.
   
   If pins are conflict, please change OCU and WFG channel(main.c) as below and connect VCC with AIN0_0, RTO04_0 with BIN0_0.
...
4) Observe display information at Hyper Terminal.
5) If pins are no conflict, connect GND with AIN0_0, RTO00_0 with BIN0_0;
   If pins are conflict, connect GND with AIN0_0, RTO04_0 with BIN0_0
6) Rebuild and run the program.
7) observe display information at Hyper Terminal.
