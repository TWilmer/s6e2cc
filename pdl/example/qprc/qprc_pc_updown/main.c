...
/** \file main.c
 **
 ** This example demonstrates the up/down mode of position counter.
 ** A couple of wave from MFT is counted by a position counter.
 ** The debug information can be observed via UART0.
 **
 ** History:
...
#ifdef DEBUG_PRINT
    printf("******************************************************\n");
    printf(" QPRC Position counter example with up/down count mode \n");
    printf("******************************************************\n\n");

    printf("Trial 1 \n");
    printf("-----------\n");
    printf("Connect WFG I/O with AIN \n\r");
    printf("Use the waveform output as input of AIN to increase PC count \n\r");

    printf("Trial 2 \n");
    printf("-----------\n");

    printf("Connect WFG I/O with BIN \n\r");
    printf("Use the waveform output as input of BIN to decrease PC count \n\n\r");
#endif
