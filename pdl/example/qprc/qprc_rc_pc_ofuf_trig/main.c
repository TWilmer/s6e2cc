...
/** \file main.c
 **
 ** This example demonstrates PC overflow trigger mode of Revolution Counter.
 **
 ** History:
 **   - 2014-11-28  0.0.1  EZh        First version for FM universal PDL.
 **
 ******************************************************************************/
...
static void InitQprc(void)
{
    ...
    stcQprcIrqCallback.pfnPcRcMatchIrqCb = RcMatchIrqHandler;
    ...
    Qprc_ConfigRcMode(&USER_QPRC, QprcRcMode2); //Up/down count of RC on overflow or underflow of position count 
...
#ifdef DEBUG_PRINT
    printf("******************************************************************************************\n\r");
    printf("*        QPRC Revolution Counter example with PC underflow and overflow trigger mode     *\n\r");
    printf("******************************************************************************************\n\n\r");

    printf("Connect WFG I/O with AIN0_0 \n\r");
    printf("If PC count overflows, PC count clears to 0 and RC count adds by 1 \n\n\r");
#endif
