...
/** \file main.c
 **
 ** This example demonstrates phase difference count mode of position counter.
...
static void InitQprc(void)
{
    ...
    /* Set PC mode */
    Qprc_ConfigPcMode(&USER_QPRC, QprcPcMode2); //PC_Mode2: Phase difference count mode: Counts up if AIN is leading BIN, down if BIN leading.
...
#ifdef DEBUG_PRINT
    printf("******************************************************\n");
    printf(" QPRC Position counter phase difference count mode \n");
    printf("******************************************************\n\n");

    printf("Trial 1 \n");
    printf("-----------\n");
    
    printf("Connect RTO00_0 with AIN \n\r");
    printf("Connect RTO01_0 with BIN \n\r");
    printf("The wave input AIN is leading that input to BIN, it will increase PC count \n\r");
    
    printf("Trial 2 \n");
    printf("-----------\n");
   
    printf("Connect RTO00_0 with BIN \n\r");
    printf("Connect RTO01_0 with AIN \n\r");
    printf("The wave input AIN is leading that input to BIN, it will decrease PC count \n\n\r");
#endif
    OverFlow_LedInit();        
    UnderFlow_LedInit();
