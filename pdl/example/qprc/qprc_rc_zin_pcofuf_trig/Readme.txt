...
2014-01-24  0.1    EZ           6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
Demo the Mode 3 of Revolution counter of QPRC.
...
1) Open Hyper Terminal and set the configuration:
   ...
   Stop Bits:    1
   Flow Control: None"
2) Connect RTO00_0 with AIN0_0 and ZIN0_0 with P14 (trigger), connect a user key to P0F
   Notice: if FM4 serial is used, please change the channel set 10 to 54 with OCU and WFG channel
   as following:
   ...
   (3). Change '#define  USER_WFG_COUPLE_CH (MFT_WFG_CH10)' to '#define  USER_WFG_COUPLE_CH   (MFT_WFG_CH54)'
   (4). Change '#define InitMftIo() {SetPinFunc_RTO00_0(); SetPinFunc_RTO01_0();}' to '#define InitMftIo()         {SetPinFunc_RTO04_0(); SetPinFunc_RTO05_0();}'
3) Rebuild and run the program. 
4) Check the information at the Hyper Ternimal (PC count matchs and PC count overflows, 
   and repeat this process)
5) Press key, and RC count matchs immediately.
