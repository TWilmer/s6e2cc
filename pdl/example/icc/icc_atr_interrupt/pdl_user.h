...
// ICC
#define PDL_PERIPHERAL_ENABLE_ICC0              PDL_ON
#define PDL_PERIPHERAL_ENABLE_ICC1              PDL_ON
...
// ICC
#define PDL_INTERRUPT_ENABLE_ICC0              PDL_ON
#define PDL_INTERRUPT_ENABLE_ICC1              PDL_ON
