...
===============================================================================================
VBAT port (P46, P47, P48, P49) test project for FM Universal PDL
...
2) Watch the VBAT port (P46, P47, P48, P49) level change, when excute the 'Vbat_PutPinPXX' function.
3) watch the bInputLevel value, after give high level to the VBAT port (P46, P47, P48, P49), 
when excute the 'Vbat_GetPinPXX' function. 
4) watch the bInputLevel value, after give Low level to the VBAT port (P46, P47, P48, P49), 
when excute the 'Vbat_GetPinPXX' function.  
