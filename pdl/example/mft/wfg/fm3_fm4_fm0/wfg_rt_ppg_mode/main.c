...
/** \file main.c
 **
 ** This example demonstrates RT-PPG mode of  waveform generator
 ** PPG0 connect to WFG10
 ** History:
 **   - 2014-12-10  0.0.1  DHo        First version.
 **
 ******************************************************************************/
...
#define WFG_MODE              WfgTimerPpgMode
#define WFG_GTEN_BITS         GtenBits11B 
#define WFG_PSEL_BITS         PselBits01B 
