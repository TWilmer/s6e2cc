...
2014-11-04  0.1    DHo         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
MFT FRT module running with polling mode
...
2) Set breakpoint at "while(1)"
3) Run the code
3) After code stops, check following variables in the watch window:
...
<FM4 TYPE3 or later product only>
m_u32OffsetCntPeakMatch: 10 (it indicates 10 peak match event occurs in offset mode)
m_u32OffsetCntZeroMatch: 10 (it indicates 10 zero match event occurs in offset mode)
m_au32OffsetChPeakMatchCount[]: all element of this array are around 15200 (Offset mode active, the offset value is 200)
m_au32OffsetChZeroMatchCount[]: all element of this array are around 200 (Offset mode active, the offset value is 200)
