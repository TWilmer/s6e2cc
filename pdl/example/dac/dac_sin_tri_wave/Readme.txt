...
================================================================================
This example using DAC conversion to ouput a wave form.
...
Usage Procedure:
================================================================================
1) connect DA0/DA1 to oscilloscope's channel input, GND to oscilloscope's GND.
2) Run the project
3) check the oscilloscope output.
    1. DA0 output a sin wave.
    2. DA1 output a triangle wave.
