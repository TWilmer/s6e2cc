...
================================================================================
This example samples a ADC channel under following condition:
Conversion mode                    :   priority mode
Trigger mode                       :   software /external trigger.
...
external trigger.
1) Connect to a DC power, PIN AN00 to V+, AVSS to V-.
2) Connect ADTG_0 to VCC.
3) Turn on the DC power.
4) Run the project.
5) Connect ADTG_0 to GND
6) Check the output value in terminal I/O if is equal to DC power settings.
