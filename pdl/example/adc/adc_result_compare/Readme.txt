...
================================================================================
This example samples an ADC channel and indicate if a voltage is equal or greater 
than setting volatage.

Conversion mode                      :   scan mode
Trigger mode                         :   software(repeating)
Voltage threshold notification       :   interrupt
...
2) Set DC power output at 0V.
3) Run the project
4) Adjust DC power output to 3V slowly. 
5) check the output in terminal I/O. when to input voltage is big than 2000(~1.6v)
   test finish. 
the test.
