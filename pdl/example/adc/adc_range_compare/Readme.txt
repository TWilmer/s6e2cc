...
2014-11-21  0.1    RZh         6.50.1  4.50  first version
================================================================================
Function description:
================================================================================
This example samples a ADC channel and indicate if a voltage within setting 
voltage is detected.

Conversion mode                     :   scan mode
Trigger mode                        :   software(repeating)
Voltage out of range notification   :   interrupt  
...
3) Run the project
4) Adjust DC power output to from 0V to 1V. 
5) check the output. when to input voltage is within setting range, then finish 
the test.
