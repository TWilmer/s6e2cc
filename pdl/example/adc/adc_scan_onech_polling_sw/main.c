 ...
 ** Main Module
 **
 ** \brief This example shows how to use the ADC with polling result.
 **
 ** This example set the ADC0 channel 0 in single conversion mode and fetch
 ** the result by polling mode.
 ** Via software trigger the conversion is started. Using Adc_GetIrqFlag()
 ** to check if a conversion is completed.
 ** When a completion is done, it read the result data and print to terminal
 ** I/O.
 **
 ** History:
 **   - 2014-12-8  1.0  RZh       First version.
 **
 ******************************************************************************/
