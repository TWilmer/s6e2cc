...
================================================================================
This example samples a ADC channel using DMA under following conditions.
Conversion mode                    :   scan mode(repeating)
Trigger mode                       :   software
Data conversion notification       :   DMA interrupt
...
================================================================================
software trigger.
1) Connect a DC power V+ to AN00, V- to AVSS.
2) Run the project
3) check the output in terminal I/O is equal to DC power display.
