...
================================================================================
This example samples multi-channels of ADC under following conditions:
Conversion mode                    :   scan mode
Trigger mode                       :   software
Data convertion notification       :   interrupt
...
Usage Procedure:
================================================================================
1) Connect DC power V+ to AN00, V- to AVSS.
2) Connect DC power V+ to AN07, V- to AVSS.
3) Turn on the DC power.
4) Run the project.
5) Check the output value in terminal I/O if is equal to DC power settings.
