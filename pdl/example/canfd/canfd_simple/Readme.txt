...
2014-12-04  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
This example tests the CANFD data transfer and receive.
...
Usage Procedure:
===============================================================================================
MCU as slave (set definition "MCANSAMPLE_MODE" to 1):
1) Start debug and run the code
2) Connect the CAN-H and CAN-L lines with USB-CAN tool
3) Open a CAN-USB tool and set baud rate to 500kbps
4) Set data frame in the CAN-USB tool with ID=0x0100, the frame (with ID=0x0200) will be echo back 
5) Set data frame in the CAN-USB tool with other IDs, the data will not be echo back

MCU as master (set definition "MCANSAMPLE_MODE" to 0):
1) Start debug and run the code
2) Connect the CAN-H and CAN-L lines with USB-CAN tool
3) Open a CAN-USB tool and set baud rate to 500kbps
4) The transfer frame can be received in the CAN-USB tool.
