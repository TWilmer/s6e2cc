...
2014-12-16  0.1    DHo         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
Demonstrate CSV reset function
...
2) Modify below macro definition corresponding with MCU type to enable main and sub clock  
   #define SCM_CTL_Val           0x0000005Aul    // <<< Define SCM_CTL here   

3) Start debug
4) Run
5) Short X0 and X1
6) Led defined in 1) A is polling (indicate CSV reset by main clock frequency error)
7) Press reset key
8) Short X0A and X1A
9) Led defined in 2) B is polling (indicate CSV reset by sub clock frequency error)
