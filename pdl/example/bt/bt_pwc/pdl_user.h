...
#define PDL_PERIPHERAL_ENABLE_BT6               PDL_ON
#define PDL_PERIPHERAL_ENABLE_BT7               PDL_ON
...
#define PDL_INTERRUPT_ENABLE_BT6               PDL_ON
#define PDL_INTERRUPT_ENABLE_BT7               PDL_ON
