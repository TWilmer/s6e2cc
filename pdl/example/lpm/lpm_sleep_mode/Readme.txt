...
===============================================================================================
Enter sleep mode and wakeup from sleep mode by external interrupt
...
Usage Procedure:
===============================================================================================
1) Connect INT00_0 with Pull-up resistance
2) Start debug
3) Stop debug (code has been programmed)
4) Give the INT00_0 pin low trigger, watch the LED (P3F) is on (it indidates MCU has been wakeup)
