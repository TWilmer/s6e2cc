...
2014-02-04  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
Enter deep standby RTC mode and wakeup from RTC interrupt
...
Usage Procedure:
===============================================================================================
1) Connect WKUP0 with pull-up resistance
2) Start debug
3) Stop debug (code has been programmed)
4) Watch LED, which will blink for several times.
5) System enter into deep standby RTC mode, and the LED will turn off.
6) After 30s (actual time: 30s-LED blinking time), MCU will be wakeup from deep standby RTC mode 
   (deep standby reset occurs and the step 1)- 5) repeats)
