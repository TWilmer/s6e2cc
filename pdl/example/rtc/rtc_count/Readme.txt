...
2014-12-11  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
This example demonstrates the RTC counter function
...
2) Watch the Terminal I/O window (Debug viewer)
   If time stamp is outputted to the Terminal I/O window (Debug viewer) for every second,
   RTC is operating normally.
3) After 1 minute, P61 outputs HIGH and LOW for every 0.5 second.This indicates alarm occurs.
