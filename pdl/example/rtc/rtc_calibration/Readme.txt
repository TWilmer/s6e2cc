...
Assistance tool:
---------------------
Oscilloscope/Frequency tester with high accuracy
...
2) Set breakpoint at "if(u16CalVal > 20)"
3) Run
4) Watch the waveform from RTCCO_2 and SUBOUT_0
5) Run again
6) Watch the frequency change from RTCCO_2 with a frequency tester.
