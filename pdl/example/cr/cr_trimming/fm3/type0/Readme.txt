...
================================================================================
This example demonstrates the CR trimming procedure
...
Usage Procedure:
================================================================================
1) Start debug and run the project
2) Watch the Terminal I/O window or UART debug interface (Debug viewer)
3) Uncomment following to watch the CR frequency at CROUT_1.
//SetPinFunc_CROUT_1();
