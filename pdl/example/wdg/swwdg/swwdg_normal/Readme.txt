...
===============================================================================================
Sample program for Software watchdog.
...
3) P61 outputs HIGH and LOW for every a few seconds.
   This operation is continued eternally.
   If P61 pin is conntcted with LED2 for example, user can confirm that the watchdog
   timer is cleared and reset by blinking LED2.
