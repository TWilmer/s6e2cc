...
/** \file main.c
 **
 ** This example demonstrates watch counter interrupt .
 ** IO polling wave can be observed at P61 during demonstration process.
 **
 ** History:
 **   - 2014-12-30  0.0.2  Ken xiao     universal PDL version.
 **
 ******************************************************************************/
...
/*!
 ******************************************************************************
 ** \brief Watch counter interrupt example code
 **
...
#ifdef DEBUG_PRINT
    printf("==================================================\n");
    printf("Watch Counter Interrupt Example Program Start \n");
    printf("==================================================\n");
#endif
    WcDemoUseMainOsc();
    WcDemoUseSubOsc();
...
#ifdef DEBUG_PRINT
    printf("==================================================\n");
    printf("Watch Counter Interrupt Example Program End \n");
    printf("==================================================\n");
#endif
    while(1);
}
...
/*!
 ******************************************************************************
 ** \brief Watch counter interrupt example code(Use Main OSC)
 **
 ** 1. Initialization.
...
static void WcDemoUseMainOsc(void)
{
    ...
    stcWcConfig.pfnIrqCallback = IoPolling;
    stcWcConfig.bTouchNvic = TRUE;                          // Enable Interrupt
    stcWcConfig.bIrqEnable = TRUE;
...
/*!
 ******************************************************************************
 ** \brief Watch counter interrupt example code(Use Sub OSC)
 **
 ** 1. Initialization.
...
/*!
 ******************************************************************************
 ** \brief Watch counter interrupt example code(Use Main CR)
 **
 ** 1. Initialization.
...
/*!
 ******************************************************************************
 ** \brief Watch counter interrupt example code(Use Sub Cr)
 **
 ** 1. Initialization.
