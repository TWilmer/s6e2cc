...
2014-11-15  0.1    EZh     6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
This example initializes Port P3D not inverted to output with the default value '0'. 
Afterwards the port output is set to '1'.
The next step is the initialization of Port P10 to input. The port state is then read-out.
