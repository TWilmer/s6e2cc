...
2014-02-09  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
Sample program for Dual Timer (using interrupt).
...
2) Watch the Terminal I/O window (Debug viewer)
   ...
   normally.
3) P61 outputs HIGH after 0.5 second, then this port outputs HIGH and LOW for every
   second.(according to DT channel 0)
   Watch the varible "u32CountDt1" for DT channel 1 interrupt count
