...
2014-11-04  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
Implement LIN communication between LIN master mode and LIN slave node with polling mode
...
Usage Procedure:
===============================================================================================
1) Make two copys of template and rename to "tempate_master" and "template_slave"
2) Start and debug template_master on a board and Start and debug template_slave on the other
   board.
3) Run the slave first
4) Step over in the master 
5) Check the transfer buffer "au8LinTxBuf" and receive buffer "au8LinRxBuf" in the master

To modify channel of master node, follow the steps:
- Change the definition of "LinCh1" to other channel
- Change the IO pin definitions
- Set the unused channel to "PDL_OFF", set the used channel to "PDL_ON" in the pdl_user.h

To modify channel of slave node, follow the steps:
- Change the definition of "LinCh1" to other channel
- Change the IO pin definitions
