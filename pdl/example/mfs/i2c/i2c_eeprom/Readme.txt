...
2014-02-10  0.1    EZh     6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
This example demonstrates how to access to AT24C02 with I2C interface.
This example supports two methods to communicate:I2C polling method and I2C interrupt method.
...
Hardware connection:
---------------------
See the description in i2c_at24cxx.h
...
1) Start debug
2) Step by step
3) Watch the variable array "au8WrBuf" and "au8RdBuf"

Note: When using other channel or MFS pins, change definitions of "EE_I2C_CH" and "InitI2cIo"
