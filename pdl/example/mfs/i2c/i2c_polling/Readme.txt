...
This example must be used with the example "i2c_slave_polling" and "i2c_master_polling¡°.
...
Usage Procedure:
===============================================================================================
1) Run the example "i2c_slave_polling"
2) Run the example "i2c_master_polling"
3) Break
4) Check the send buffer(au8I2cMasterTxBuf) and receive buffer(au8I2cMasterRxBuf)
