...
===============================================================================================
Demo the communication between UART0 and UART1 with interrupt mode using DMA
...
2) Break 
3) Check the TX buffer(au8UartTxBuf) and RX buffer(au8UartRxBuf). 
