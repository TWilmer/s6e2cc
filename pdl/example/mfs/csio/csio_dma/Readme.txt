...
2015-01-05  0.1    DHo     6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
Demo the communication between CSIO0 and CSIO1 with interrupt mode using DMA.
CSIO0 atcs as Master and CSIO1 atcs as Slave, at first Master sends data to slave and then
...
3) Run
4) Check the Master transfer buffer array and Slave receive buffer array (same: no error)
5) Set the breakpoint at "if(Error == CompareData(au8CsioMasterRxBuf, au8CsioSlaveTxBuf, SAMPLE_CSIO_MASTER_RX_BUFFSIZE))" 
6) Run
7) Check the Slave transfer buffer array and Master receive buffer array (same: no error)
