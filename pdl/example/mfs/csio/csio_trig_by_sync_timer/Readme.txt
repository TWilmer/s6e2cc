...
2014-11-10  0.1    Edison  6.50.1  4.70  first version
===============================================================================================                                                       
Function description:
===============================================================================================
Demo the communication between CSIO1 and CSIO3 with interrupt mode.
CSIO1 atcs as Master and CSIO3 acts as Slave, at first Master sends data to slave and then
Master reads data from slave. The CSIO1 TX and RX is triggered by CSIO series timer.
...
Usage Procedure:
===============================================================================================
1) Rebuild program and start debug
2) Set the breakpoint at "if(Error == CompareData(au8CsioMasterTxBuf, au8CsioSlaveRxBuf, SAMPLE_CSIO_SLAVE_RX_BUFFSIZE))"
3) Run
4) Check the Master transfer buffer array and Slave receive buffer array
5) Set the breakpoint at "if(Error == CompareData(au8CsioMasterRxBuf, au8CsioSlaveTxBuf, SAMPLE_CSIO_MASTER_RX_BUFFSIZE))" 
6) Run
7) Check the Slave transfer buffer array and Master receive buffer array
