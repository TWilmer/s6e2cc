...
2015-02-12  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
This example demos the hardware tranfer of DSTC, the Base Timer interrupt is used to trigger
DSTC transferring.
...
2) Run
3) Break, and check if code stops at "while(1)". And also check if the data in the array of 
