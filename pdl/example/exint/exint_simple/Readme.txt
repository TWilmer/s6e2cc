...
2014-11-21  0.1    EZh         6.50.1  4.50  first version
===============================================================================================
Function description:
===============================================================================================
This example configures two external interrupt channels with falling edge and rising edge 
detection mode and demonstrates the external interrupt occurrence with valid edge input.
Also NMI interrupt is demonstrated with a falling edge input in the NMIX pin.
...
Usage Procedure:
===============================================================================================
1) Pull-up INT00_2 and NMIX, pull-down INT03_2
2) Run the project
3) Connect INT00_2 to GND
4) Check if External Interrupt 0 occurs by watching the variable "u32ExtInt0Count"
5) Connect INT03_2 to VCC
6) Check if External Interrupt 3 occurs by watching the variable "u32ExtInt1Count"
7) Connect NMIX to GND
8) Check if NMI interrupt occurs by watching the variable "u32NmiCount"
