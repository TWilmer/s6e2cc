                            ...
                            stc_mft_adcmp_config_t* pstcConfig)
{
    ...
    switch(u8Ch)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            pstcACFS32->FSA0 = (uint8_t)pstcConfig->enFrt;
            break;
        case 3:
            pstcACFS32->FSA1 = (uint8_t)pstcConfig->enFrt;
            break;
        case 4:
            pstcACFS54->FSA0 = (uint8_t)pstcConfig->enFrt;
            break;
        case 5:
            pstcACFS54->FSA1 = (uint8_t)pstcConfig->enFrt;
            break;
        default:
            return ErrorInvalidParameter;
    }
                               ...
                               stc_mft_adcmp_config_fm3_t *pstcConfig)
{
    ...
    switch(u8FM3Ch)
    {
        case MFT_ADCMP_CH10:     
            ...
            pstcACFS10->FSA1 = (uint8_t)pstcConfig->enFrt;
        #else
            pstcACSA->CE10 = (uint8_t)pstcConfig->enFrt + 1u;
        #endif
            break;
        case MFT_ADCMP_CH32:
        #if (PDL_MCU_CORE == PDL_FM4_CORE) || (PDL_MCU_CORE == PDL_FM0P_CORE)   
            ...
            pstcACFS32->FSA1 = (uint8_t)pstcConfig->enFrt;
        #else
            pstcACSA->CE32 = (uint8_t)pstcConfig->enFrt + 1u;
        #endif
            break;
        case MFT_ADCMP_CH54:
        #if (PDL_MCU_CORE == PDL_FM4_CORE) || (PDL_MCU_CORE == PDL_FM0P_CORE)   
            ...
            pstcACFS54->FSA1 = (uint8_t)pstcConfig->enFrt;
        #else
            pstcACSA->CE54 = (uint8_t)pstcConfig->enFrt + 1u;
        #endif    
            break;
        default:
            return ErrorInvalidParameter;
