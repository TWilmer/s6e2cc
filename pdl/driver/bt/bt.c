...
static void BtInitNvic(volatile stc_btn_t* pstcBt)
{
    ...
    {
        NVIC_ClearPendingIRQ(BTIM0_4_IRQn); 
        NVIC_EnableIRQ(BTIM0_4_IRQn); 
        NVIC_SetPriority(BTIM0_4_IRQn, PDL_IRQ_LEVEL_BT0_4);
    }
  #endif
  #if (PDL_INTERRUPT_ENABLE_BT1 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT5 == PDL_ON)   
    if((pstcBt == &BT1) || (pstcBt == &BT5))
    {
        NVIC_ClearPendingIRQ(BTIM1_5_IRQn); 
        NVIC_EnableIRQ(BTIM1_5_IRQn); 
        NVIC_SetPriority(BTIM1_5_IRQn, PDL_IRQ_LEVEL_BT1_5);
    }
  #endif
  #if (PDL_INTERRUPT_ENABLE_BT2 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT6 == PDL_ON)   
    if((pstcBt == &BT2) || (pstcBt == &BT6))
    {
        NVIC_ClearPendingIRQ(BTIM2_6_IRQn); 
        NVIC_EnableIRQ(BTIM2_6_IRQn); 
        NVIC_SetPriority(BTIM2_6_IRQn, PDL_IRQ_LEVEL_BT2_6);
    }
  #endif
  #if (PDL_INTERRUPT_ENABLE_BT3 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT7 == PDL_ON)   
    if((pstcBt == &BT3) || (pstcBt == &BT7))
    {
        NVIC_ClearPendingIRQ(BTIM3_7_IRQn); 
        NVIC_EnableIRQ(BTIM3_7_IRQn); 
        NVIC_SetPriority(BTIM3_7_IRQn, PDL_IRQ_LEVEL_BT3_7);
    }
  #endif     
#else  
    NVIC_ClearPendingIRQ(BTIM0_7_FLASH_IRQn); 
    NVIC_EnableIRQ(BTIM0_7_FLASH_IRQn); 
    NVIC_SetPriority(BTIM0_7_FLASH_IRQn, PDL_IRQ_LEVEL_BT0_7_FLASH);
#endif    
#elif (PDL_MCU_CORE == PDL_FM3_CORE)
    NVIC_ClearPendingIRQ(BTIM0_7_IRQn); 
    NVIC_EnableIRQ(BTIM0_7_IRQn); 
    NVIC_SetPriority(BTIM0_7_IRQn, PDL_IRQ_LEVEL_BT0_7);
...
{        
  ...
  #if (PDL_INTERRUPT_ENABLE_BT0 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT4 == PDL_ON)  
    NVIC_ClearPendingIRQ(BTIM0_4_IRQn); 
    NVIC_DisableIRQ(BTIM0_4_IRQn); 
    NVIC_SetPriority(BTIM0_4_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
  #endif 
  #if (PDL_INTERRUPT_ENABLE_BT1 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT5 == PDL_ON)  
    NVIC_ClearPendingIRQ(BTIM1_5_IRQn); 
    NVIC_DisableIRQ(BTIM1_5_IRQn); 
    NVIC_SetPriority(BTIM1_5_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
  #endif
  #if (PDL_INTERRUPT_ENABLE_BT2 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT6 == PDL_ON)  
    NVIC_ClearPendingIRQ(BTIM2_6_IRQn); 
    NVIC_DisableIRQ(BTIM2_6_IRQn); 
    NVIC_SetPriority(BTIM2_6_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
  #endif
  #if (PDL_INTERRUPT_ENABLE_BT3 == PDL_ON) || (PDL_INTERRUPT_ENABLE_BT7 == PDL_ON)  
    NVIC_ClearPendingIRQ(BTIM3_7_IRQn); 
    NVIC_DisableIRQ(BTIM3_7_IRQn); 
    NVIC_SetPriority(BTIM3_7_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
  #endif  
#else
    NVIC_ClearPendingIRQ(BTIM0_7_FLASH_IRQn); 
    NVIC_DisableIRQ(BTIM0_7_FLASH_IRQn); 
    NVIC_SetPriority(BTIM0_7_FLASH_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
#endif    
#elif (PDL_MCU_CORE == PDL_FM3_CORE)
    NVIC_ClearPendingIRQ(BTIM0_7_IRQn); 
    NVIC_DisableIRQ(BTIM0_7_IRQn); 
    NVIC_SetPriority(BTIM0_7_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);
#elif (PDL_MCU_CORE == PDL_FM4_CORE)    
      #if (PDL_INTERRUPT_ENABLE_BT0 == PDL_ON)  
    if(&BT0 == pstcBt)
    {
