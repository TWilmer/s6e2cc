 ...
 **
 ** History:
 **   - 2014-02-13  1.0  Edison Zhang  First version for FM uinversal PDL.
 **
 ******************************************************************************/
...
stc_mfs_instance_data_t m_astcMfsInstanceDataLut[MFS_INSTANCE_COUNT] =
{
    ...
    {
        {&UART0, &CSIO0, &I2C0, &LIN0}, // pstcInstance 
        {
    ...
    {
        {&UART1, &CSIO1, &I2C1, &LIN1}, /* pstcInstance */
        {
            MfsInitMode,           //  MFS initial mode 
            0u,                    // stcInternData (not initialized yet) 
        }  
    ...
    {
        {&UART2, &CSIO2, &I2C2, &LIN2}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART3, &CSIO3, &I2C3, &LIN3}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet)
    ...
    {
        {&UART4, &CSIO4, &I2C4, &LIN4}, // pstcInstance
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART5, &CSIO5, &I2C5, &LIN5}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet)
        } 
    ...
    {
        {&UART6, &CSIO6, &I2C6, &LIN6}, // pstcInstance 
        {
            MfsInitMode,                // MFS initial mode
            0u,                         // stcInternData (not initialized yet)
        } 
    ...
    {
        {&UART7, &CSIO7, &I2C7, &LIN7}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART8, &CSIO8, &I2C8, &LIN8}, // pstcInstance
        {
            MfsInitMode,            // MFS initial mode
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART9, &CSIO9, &I2C9, &LIN9}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART10, &CSIO10, &I2C10, &LIN10}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART11, &CSIO11, &I2C11, &LIN11}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART12, &CSIO12, &I2C12, &LIN12}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet)
        } 
    ...
    {
        {&UART13, &CSIO13, &I2C13, &LIN13}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet)
        } 
    ...
    {
        {&UART14, &CSIO14, &I2C14, &LIN14}, // pstcInstance 
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet) 
        } 
    ...
    {
        {&UART15, &CSIO15, &I2C15, &LIN15}, // pstcInstance
        {
            MfsInitMode,            // MFS initial mode 
            0u,                     // stcInternData (not initialized yet)
        } 
...
static void MfsInitNvic(uint8_t u8Ch, boolean_t bRxTx)
{
    ...
    enIrqIndex = (IRQn_Type)(MFS0_IRQn + u8Ch);
    ...
    uint8_t au8PrioLevel[16] = 
    {
        ...
        PDL_IRQ_LEVEL_MFS6_14_RX_DMA0, PDL_IRQ_LEVEL_MFS6_14_TX_DMA1,
        PDL_IRQ_LEVEL_MFS7_15_RX_DMA2, PDL_IRQ_LEVEL_MFS7_15_TX_DMA3,
    };
    ...
    #if (PDL_MCU_TYPE == PDL_FM4_TYPE1) || (PDL_MCU_TYPE == PDL_FM4_TYPE2) || \
        (PDL_MCU_TYPE == PDL_FM4_TYPE3) || (PDL_MCU_TYPE == PDL_FM4_TYPE5)	
                          ...
                          stc_mfs_uart_config_t* pstcConfig)
{
    ...
    if(pstcConfig->pstcFifoConfig != NULL)
    {
        ...
        /* Enable FIFO  */
        pstcUart->FCR0_f.FE1 = 1u;
        pstcUart->FCR0_f.FE2 = 1u;
    }
...
#if (PDL_MCU_CORE == PDL_FM0P_CORE)    
    u32Pclk1 = __HCLK/(1ul << (APBC1_PSR_Val & 0x03u)); /* MFS is attached on APB1 bus in FM0+ device */
#else
                             ...
                             en_uart_status_t enStatus)
{
    ...
    switch(enStatus)
    {
        ...
        case UartTxFifoRequest:
            bResult = (pstcUart->FCR1_f.FDRQ == 1u) ? TRUE : FALSE;
            break;  
        default:
            break;  
    }
                                ...
                                en_mfs_fifo_t enFifo)
{
    ...
    {
        case MfsFifo1:
            pstcUart->FCR0_f.FCL1 = 1u;
            break;
        case MfsFifo2:
            pstcUart->FCR0_f.FCL2 = 1u;
            break;
        default:
            return ErrorInvalidParameter;
    }
                          ...
                          stc_mfs_csio_config_t* pstcConfig)
{
    ...
    /* Preset local register variables to zero */
    stc_mfs_csio_smr_field_t  stcSMR  = { 0u };
    stc_mfs_csio_scr_field_t  stcSCR  = { 0u };
    stc_mfs_csio_ssr_field_t  stcSSR  = { 0u };
    stc_mfs_csio_escr_field_t stcESCR = { 0u };
    ...
    {
        /* Reset FIFO */
        pstcCsio->FCR0_f.FCL1 = 0u;
        pstcCsio->FCR0_f.FCL2 = 0u;
        /* Enable FIFO receive Idle detection */
        pstcCsio->FCR1_f.FRIIE = 1;
        /* Selection TX and RX FIFO  */
        switch(pstcConfig->pstcFifoConfig->enFifoSel)
        {
            case MfsTxFifo1RxFifo2:
                pstcCsio->FCR1_f.FSEL = 0u;
                break;
            case MfsTxFifo2RxFifo1:
                pstcCsio->FCR1_f.FSEL = 1u;
                break;
            default:
               return (ErrorInvalidParameter);
        }
        ...
        /* Enable FIFO  */
        pstcCsio->FCR0_f.FE1 = 1u;
        pstcCsio->FCR0_f.FE2 = 1u;
    }
...
#if (PDL_MCU_CORE == PDL_FM0P_CORE)        
    u32Pclk1 = __HCLK/(1ul << (APBC1_PSR_Val & 0x03u)); /* MFS is attached on APB1 bus for FM0+ */
#else
    u32Pclk1 = __HCLK/(1ul << (APBC2_PSR_Val & 0x03u)); /* MFS is attached on APB2 bus for FM3 and FM4 */
#endif    
                               ...
                               en_csio_status_t enStatus)
{
    ...
    switch(enStatus)
    {
        ...
        case CsioTxFifoRequest:
            bRet = (1u == pstcCsio->FCR1_f.FDRQ) ? TRUE : FALSE;
            break;
    #if (PDL_MCU_CORE == PDL_FM4_CORE) || (PDL_MCU_CORE == PDL_FM0P_CORE)        
                                ...
                                en_mfs_fifo_t enFifo)
{
    ...
    {
        case MfsFifo1:
            pstcCsio->FCR0_f.FCL1 = 1u;
            break;
        case MfsFifo2:
            pstcCsio->FCR0_f.FCL2 = 1u;
            break;
        default:
            return ErrorInvalidParameter;
    }
                         ...
                         stc_mfs_i2c_config_t* pstcConfig)
{
	...
	/* Preset local register variables to zero */
    stc_mfs_i2c_smr_field_t   stcSMR   = { 0u };
    stc_mfs_i2c_ibcr_field_t  stcIBCR  = { 0u };
    stc_mfs_i2c_isba_field_t  stcISBA  = { 0u };
    stc_mfs_i2c_ismk_field_t  stcISMK  = { 0u };
    ...
    {
        /* Reset FIFO */
        pstcI2c->FCR0_f.FCL1 = 1u;
        pstcI2c->FCR0_f.FCL2 = 1u;
        /* Enable FIFO receive Idle detection */
        pstcI2c->FCR1_f.FRIIE = 1;
        /* Selection TX and RX FIFO  */
        switch(pstcConfig->pstcFifoConfig->enFifoSel)
        {
            case MfsTxFifo1RxFifo2:
                pstcI2c->FCR1_f.FSEL = 0u;
                break;
            case MfsTxFifo2RxFifo1:
                pstcI2c->FCR1_f.FSEL = 1u;
                break;
            default:
               return (ErrorInvalidParameter);
        }
        ...
        /* Enable FIFO  */
        pstcI2c->FCR0_f.FE1 = 1;
        pstcI2c->FCR0_f.FE2 = 1;
    }
                            ...
                            en_i2c_status_t enStatus)
{
    ...
    switch(enStatus)
    {
        ...
        case I2cTxFifoRequest:
            bRet = (1u == pstcI2c->FCR1_f.FDRQ) ? TRUE : FALSE;
            break;  
                          ...
                          stc_mfs_lin_config_t* pstcConfig)
{
    ...
    uint8_t u8Ch;
	  ...
	  /* Preset local register variables to zero */
    stc_mfs_lin_smr_field_t  stcSMR  = { 0u };
    stc_mfs_lin_scr_field_t  stcSCR  = { 0u };
    stc_mfs_lin_escr_field_t stcESCR = { 0u };
    ...
    {
        /* Reset FIFO */
        pstcLin->FCR0_f.FCL1 = 1u;
        pstcLin->FCR0_f.FCL2 = 1u;
        /* Enable FIFO receive Idle detection */
        pstcLin->FCR1_f.FRIIE = 1u;
        /* Selection TX and RX FIFO  */
        switch(pstcConfig->pstcFifoConfig->enFifoSel)
        {
            case MfsTxFifo1RxFifo2:
                pstcLin->FCR1_f.FSEL = 0u;
                break;
            case MfsTxFifo2RxFifo1:
                pstcLin->FCR1_f.FSEL = 1u;
                break;
            default:
               return (ErrorInvalidParameter);
        }
        ...
        /* Enable FIFO  */
        pstcLin->FCR0_f.FE1 = 1u;
        pstcLin->FCR0_f.FE2 = 1u;
    }
                            ...
                            en_lin_status_t enStatus)
{
    ...
    switch(enStatus)
    {
        ...
        case LinTxFifoRequest:
            bResult = (1u == pstcLin->FCR1_f.FDRQ) ? TRUE : FALSE;
            break;  
        default:
            break;  
    }
