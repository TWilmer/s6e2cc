 ...
 ** @link I2csGroup I2C Slave Module description @endlink
 **
 ** History:
                      ...
                      stc_i2cs_config_t* pstcConfig)
{
    ...
    stc_i2cs_ibscr_field_t    stcIBSCR  = { 0u };
    stc_i2cs_ibsadr_field_t   stcIBSADR = { 0u };
    stc_i2cs_ibsmskr_field_t  stcIBSMSKR  = { 0u };
    stc_i2cs_ibsdstupr_field_t stcIBSDSTUPR = { 0u };
    ...
    /* Set registers value */
    pstcI2cs->IBRDSTUPR_f = stcIBSDSTUPR;
