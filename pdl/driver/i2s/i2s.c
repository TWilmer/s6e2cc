...
{
    NVIC_ClearPendingIRQ(I2S_PCRC_IRQn);
    NVIC_EnableIRQ(I2S_PCRC_IRQn);
    NVIC_SetPriority(I2S_PCRC_IRQn, PDL_IRQ_LEVEL_I2S_PCRC);   
} // I2s_InitNvic
...
{
    NVIC_ClearPendingIRQ(I2S_PCRC_IRQn);
    NVIC_DisableIRQ(I2S_PCRC_IRQn);
    NVIC_SetPriority(I2S_PCRC_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);   
} // I2sDeInitNvic
