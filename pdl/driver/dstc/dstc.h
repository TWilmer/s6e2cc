 ...
 **   - 2015-02-09  1.1  EZh  Port to FM universal PDL frame.
 **
 ******************************************************************************/
...
#define DSTC_IRQ_NUMBER_EXTINT0                  16u
#define DSTC_IRQ_NUMBER_EXTINT1                  17u
#define DSTC_IRQ_NUMBER_EXTINT2                  18u
#define DSTC_IRQ_NUMBER_EXTINT3                  19u
#define DSTC_IRQ_NUMBER_EXTINT4                  20u
#define DSTC_IRQ_NUMBER_EXTINT5                  21u
#define DSTC_IRQ_NUMBER_EXTINT6                  22u
#define DSTC_IRQ_NUMBER_EXTINT7                  23u
#define DSTC_IRQ_NUMBER_EXTINT8                  24u
#define DSTC_IRQ_NUMBER_EXTINT12                 28u
#define DSTC_IRQ_NUMBER_EXTINT13                 29u
#define DSTC_IRQ_NUMBER_EXTINT15                 31u
