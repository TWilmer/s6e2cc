 ...
 **
 ** History:
 **   - 2014-11-20  1.0  EZh  First version for FM universal PDL.
 **
 ******************************************************************************/
...
static en_result_t DmaInitNvic(uint8_t u8DmaChannel)
{
  ...
  IRQn_Type enDmaIrqIndex;
  enDmaIrqIndex = (IRQn_Type)(u8DmaChannel + DMAC0_IRQn);
  
  NVIC_ClearPendingIRQ(enDmaIrqIndex);
  NVIC_EnableIRQ(enDmaIrqIndex);
  NVIC_SetPriority(enDmaIrqIndex, PDL_IRQ_LEVEL_DMA0);
#else  
  switch(u8DmaChannel)
  {
    case 0u:
    ...
    case 1u:
      ...
      break;
    case 2u:
      NVIC_ClearPendingIRQ(MFS7_15_RX_DMA2_IRQn);
      NVIC_EnableIRQ(MFS7_15_RX_DMA2_IRQn);
      NVIC_SetPriority(MFS7_15_RX_DMA2_IRQn, PDL_IRQ_LEVEL_MFS7_15_RX_DMA2);    
      break;
    case 3u:
      NVIC_ClearPendingIRQ(MFS7_15_TX_DMA3_IRQn);
      NVIC_EnableIRQ(MFS7_15_TX_DMA3_IRQn);
      NVIC_SetPriority(MFS7_15_TX_DMA3_IRQn, PDL_IRQ_LEVEL_MFS7_15_TX_DMA3);    
      break;  
    default:
      break;
  }
...
static en_result_t DmaDeInitNvic(uint8_t u8DmaChannel)
{
  ...
  NVIC_ClearPendingIRQ(enDmaIrqIndex);
  NVIC_DisableIRQ(enDmaIrqIndex);
  NVIC_SetPriority(enDmaIrqIndex, PDL_DEFAULT_INTERRUPT_LEVEL);     
#else  
  switch(u8DmaChannel)
  {
    case 0:      
    ...
    case 2:        
      NVIC_ClearPendingIRQ(MFS7_15_RX_DMA2_IRQn);
      NVIC_DisableIRQ(MFS7_15_RX_DMA2_IRQn);
      NVIC_SetPriority(MFS7_15_RX_DMA2_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);        
      break;
    case 3:        
      NVIC_ClearPendingIRQ(MFS7_15_TX_DMA3_IRQn);
      NVIC_DisableIRQ(MFS7_15_TX_DMA3_IRQn);
      NVIC_SetPriority(MFS7_15_TX_DMA3_IRQn, PDL_DEFAULT_INTERRUPT_LEVEL);      
      break;   
    default:
      break;
  }
