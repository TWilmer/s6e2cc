...
*/
/************************************************************************************/
/** \file gpio_s6e2dfxj.h
 **
 ** Headerfile for S6E2DFXJ GPIO functions, included in gpio.h
 **
 ** History:
 **   - 2014-05-04  1.0  EZh    First version
 **   - 2014-12-25  1.1  EZh    Correct AN pin definition
 **   - 2015-01-23  1.2  EZh    Add P3B pin definition
 **   - 2015-01-23  1.3  EZh    Modify bFM_GPIO_EPFR00_TRACExE to bFM_GPIO_EPFR00_TRCxE 
 **
 ******************************************************************************/

#ifndef __GPIO_S6E2DFXJ_H__
#define __GPIO_S6E2DFXJ_H__
...
#define GPIO1PIN_PD4_GET             ( bFM_GPIO_PDIRD_P4 )

#define GPIO1PIN_PD4_PUT(v)          ( bFM_GPIO_PDORD_P4=(v) )

#define GPIO1PIN_PD4_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD4_INITIN(v) \
                                                        : GPIO1PIN_PD4_INITOUT(v) )

#define GPIO1PIN_PD4_INITIN(v)       do{ bFM_GPIO_PCRD_P4=(v).bPullup; \
                                         bFM_GPIO_DDRD_P4=0u; \
                                         bFM_GPIO_PFRD_P4=0u; }while(0u)

#define GPIO1PIN_PD4_INITOUT(v)      do{ bFM_GPIO_PDORD_P4=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P4=1u; \
                                         bFM_GPIO_PFRD_P4=0u; }while(0u)


/*---- GPIO bit NPD4 ----*/
#define GPIO1PIN_NPD4_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P4)) )

#define GPIO1PIN_NPD4_PUT(v)         ( bFM_GPIO_PDORD_P4=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD4_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD4_INITIN(v) \
                                                        : GPIO1PIN_NPD4_INITOUT(v) )

#define GPIO1PIN_NPD4_INITIN(v)      do{ bFM_GPIO_PCRD_P4=(v).bPullup; \
                                         bFM_GPIO_DDRD_P4=0u; \
                                         bFM_GPIO_PFRD_P4=0u; }while(0u)

#define GPIO1PIN_NPD4_INITOUT(v)     do{ bFM_GPIO_PDORD_P4=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P4=1u; \
                                         bFM_GPIO_PFRD_P4=0u; }while(0u)
...
#define GPIO1PIN_PD5_GET             ( bFM_GPIO_PDIRD_P5 )

#define GPIO1PIN_PD5_PUT(v)          ( bFM_GPIO_PDORD_P5=(v) )

#define GPIO1PIN_PD5_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD5_INITIN(v) \
                                                        : GPIO1PIN_PD5_INITOUT(v) )

#define GPIO1PIN_PD5_INITIN(v)       do{ bFM_GPIO_PCRD_P5=(v).bPullup; \
                                         bFM_GPIO_DDRD_P5=0u; \
                                         bFM_GPIO_PFRD_P5=0u; }while(0u)

#define GPIO1PIN_PD5_INITOUT(v)      do{ bFM_GPIO_PDORD_P5=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P5=1u; \
                                         bFM_GPIO_PFRD_P5=0u; }while(0u)


/*---- GPIO bit NPD5 ----*/
#define GPIO1PIN_NPD5_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P5)) )

#define GPIO1PIN_NPD5_PUT(v)         ( bFM_GPIO_PDORD_P5=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD5_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD5_INITIN(v) \
                                                        : GPIO1PIN_NPD5_INITOUT(v) )

#define GPIO1PIN_NPD5_INITIN(v)      do{ bFM_GPIO_PCRD_P5=(v).bPullup; \
                                         bFM_GPIO_DDRD_P5=0u; \
                                         bFM_GPIO_PFRD_P5=0u; }while(0u)

#define GPIO1PIN_NPD5_INITOUT(v)     do{ bFM_GPIO_PDORD_P5=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P5=1u; \
                                         bFM_GPIO_PFRD_P5=0u; }while(0u)
...
#define GPIO1PIN_PD6_GET             ( bFM_GPIO_PDIRD_P6 )

#define GPIO1PIN_PD6_PUT(v)          ( bFM_GPIO_PDORD_P6=(v) )

#define GPIO1PIN_PD6_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD6_INITIN(v) \
                                                        : GPIO1PIN_PD6_INITOUT(v) )

#define GPIO1PIN_PD6_INITIN(v)       do{ bFM_GPIO_PCRD_P6=(v).bPullup; \
                                         bFM_GPIO_DDRD_P6=0u; \
                                         bFM_GPIO_PFRD_P6=0u; }while(0u)

#define GPIO1PIN_PD6_INITOUT(v)      do{ bFM_GPIO_PDORD_P6=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P6=1u; \
                                         bFM_GPIO_PFRD_P6=0u; }while(0u)


/*---- GPIO bit NPD6 ----*/
#define GPIO1PIN_NPD6_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P6)) )

#define GPIO1PIN_NPD6_PUT(v)         ( bFM_GPIO_PDORD_P6=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD6_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD6_INITIN(v) \
                                                        : GPIO1PIN_NPD6_INITOUT(v) )

#define GPIO1PIN_NPD6_INITIN(v)      do{ bFM_GPIO_PCRD_P6=(v).bPullup; \
                                         bFM_GPIO_DDRD_P6=0u; \
                                         bFM_GPIO_PFRD_P6=0u; }while(0u)

#define GPIO1PIN_NPD6_INITOUT(v)     do{ bFM_GPIO_PDORD_P6=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P6=1u; \
                                         bFM_GPIO_PFRD_P6=0u; }while(0u)
...
#define GPIO1PIN_PD7_GET             ( bFM_GPIO_PDIRD_P7 )

#define GPIO1PIN_PD7_PUT(v)          ( bFM_GPIO_PDORD_P7=(v) )

#define GPIO1PIN_PD7_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD7_INITIN(v) \
                                                        : GPIO1PIN_PD7_INITOUT(v) )

#define GPIO1PIN_PD7_INITIN(v)       do{ bFM_GPIO_PCRD_P7=(v).bPullup; \
                                         bFM_GPIO_DDRD_P7=0u; \
                                         bFM_GPIO_PFRD_P7=0u; }while(0u)

#define GPIO1PIN_PD7_INITOUT(v)      do{ bFM_GPIO_PDORD_P7=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P7=1u; \
                                         bFM_GPIO_PFRD_P7=0u; }while(0u)


/*---- GPIO bit NPD7 ----*/
#define GPIO1PIN_NPD7_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P7)) )

#define GPIO1PIN_NPD7_PUT(v)         ( bFM_GPIO_PDORD_P7=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD7_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD7_INITIN(v) \
                                                        : GPIO1PIN_NPD7_INITOUT(v) )

#define GPIO1PIN_NPD7_INITIN(v)      do{ bFM_GPIO_PCRD_P7=(v).bPullup; \
                                         bFM_GPIO_DDRD_P7=0u; \
                                         bFM_GPIO_PFRD_P7=0u; }while(0u)

#define GPIO1PIN_NPD7_INITOUT(v)     do{ bFM_GPIO_PDORD_P7=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P7=1u; \
                                         bFM_GPIO_PFRD_P7=0u; }while(0u)
...
#define GPIO1PIN_PD8_GET             ( bFM_GPIO_PDIRD_P8 )

#define GPIO1PIN_PD8_PUT(v)          ( bFM_GPIO_PDORD_P8=(v) )

#define GPIO1PIN_PD8_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD8_INITIN(v) \
                                                        : GPIO1PIN_PD8_INITOUT(v) )

#define GPIO1PIN_PD8_INITIN(v)       do{ bFM_GPIO_PCRD_P8=(v).bPullup; \
                                         bFM_GPIO_DDRD_P8=0u; \
                                         bFM_GPIO_PFRD_P8=0u; }while(0u)

#define GPIO1PIN_PD8_INITOUT(v)      do{ bFM_GPIO_PDORD_P8=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P8=1u; \
                                         bFM_GPIO_PFRD_P8=0u; }while(0u)


/*---- GPIO bit NPD8 ----*/
#define GPIO1PIN_NPD8_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P8)) )

#define GPIO1PIN_NPD8_PUT(v)         ( bFM_GPIO_PDORD_P8=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD8_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD8_INITIN(v) \
                                                        : GPIO1PIN_NPD8_INITOUT(v) )

#define GPIO1PIN_NPD8_INITIN(v)      do{ bFM_GPIO_PCRD_P8=(v).bPullup; \
                                         bFM_GPIO_DDRD_P8=0u; \
                                         bFM_GPIO_PFRD_P8=0u; }while(0u)

#define GPIO1PIN_NPD8_INITOUT(v)     do{ bFM_GPIO_PDORD_P8=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P8=1u; \
                                         bFM_GPIO_PFRD_P8=0u; }while(0u)
...
#define GPIO1PIN_PD9_GET             ( bFM_GPIO_PDIRD_P9 )

#define GPIO1PIN_PD9_PUT(v)          ( bFM_GPIO_PDORD_P9=(v) )

#define GPIO1PIN_PD9_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PD9_INITIN(v) \
                                                        : GPIO1PIN_PD9_INITOUT(v) )

#define GPIO1PIN_PD9_INITIN(v)       do{ bFM_GPIO_PCRD_P9=(v).bPullup; \
                                         bFM_GPIO_DDRD_P9=0u; \
                                         bFM_GPIO_PFRD_P9=0u; }while(0u)

#define GPIO1PIN_PD9_INITOUT(v)      do{ bFM_GPIO_PDORD_P9=(v).bInitVal; \
                                         bFM_GPIO_DDRD_P9=1u; \
                                         bFM_GPIO_PFRD_P9=0u; }while(0u)


/*---- GPIO bit NPD9 ----*/
#define GPIO1PIN_NPD9_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_P9)) )

#define GPIO1PIN_NPD9_PUT(v)         ( bFM_GPIO_PDORD_P9=(uint32_t)(!(v)) )

#define GPIO1PIN_NPD9_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPD9_INITIN(v) \
                                                        : GPIO1PIN_NPD9_INITOUT(v) )

#define GPIO1PIN_NPD9_INITIN(v)      do{ bFM_GPIO_PCRD_P9=(v).bPullup; \
                                         bFM_GPIO_DDRD_P9=0u; \
                                         bFM_GPIO_PFRD_P9=0u; }while(0u)

#define GPIO1PIN_NPD9_INITOUT(v)     do{ bFM_GPIO_PDORD_P9=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_P9=1u; \
                                         bFM_GPIO_PFRD_P9=0u; }while(0u)
...
#define GPIO1PIN_PDA_GET             ( bFM_GPIO_PDIRD_PA )

#define GPIO1PIN_PDA_PUT(v)          ( bFM_GPIO_PDORD_PA=(v) )

#define GPIO1PIN_PDA_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PDA_INITIN(v) \
                                                        : GPIO1PIN_PDA_INITOUT(v) )

#define GPIO1PIN_PDA_INITIN(v)       do{ bFM_GPIO_PCRD_PA=(v).bPullup; \
                                         bFM_GPIO_DDRD_PA=0u; \
                                         bFM_GPIO_PFRD_PA=0u; }while(0u)

#define GPIO1PIN_PDA_INITOUT(v)      do{ bFM_GPIO_PDORD_PA=(v).bInitVal; \
                                         bFM_GPIO_DDRD_PA=1u; \
                                         bFM_GPIO_PFRD_PA=0u; }while(0u)


/*---- GPIO bit NPDA ----*/
#define GPIO1PIN_NPDA_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_PA)) )

#define GPIO1PIN_NPDA_PUT(v)         ( bFM_GPIO_PDORD_PA=(uint32_t)(!(v)) )

#define GPIO1PIN_NPDA_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPDA_INITIN(v) \
                                                        : GPIO1PIN_NPDA_INITOUT(v) )

#define GPIO1PIN_NPDA_INITIN(v)      do{ bFM_GPIO_PCRD_PA=(v).bPullup; \
                                         bFM_GPIO_DDRD_PA=0u; \
                                         bFM_GPIO_PFRD_PA=0u; }while(0u)

#define GPIO1PIN_NPDA_INITOUT(v)     do{ bFM_GPIO_PDORD_PA=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_PA=1u; \
                                         bFM_GPIO_PFRD_PA=0u; }while(0u)
...
#define GPIO1PIN_PDB_GET             ( bFM_GPIO_PDIRD_PB )

#define GPIO1PIN_PDB_PUT(v)          ( bFM_GPIO_PDORD_PB=(v) )

#define GPIO1PIN_PDB_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PDB_INITIN(v) \
                                                        : GPIO1PIN_PDB_INITOUT(v) )

#define GPIO1PIN_PDB_INITIN(v)       do{ bFM_GPIO_PCRD_PB=(v).bPullup; \
                                         bFM_GPIO_DDRD_PB=0u; \
                                         bFM_GPIO_PFRD_PB=0u; }while(0u)

#define GPIO1PIN_PDB_INITOUT(v)      do{ bFM_GPIO_PDORD_PB=(v).bInitVal; \
                                         bFM_GPIO_DDRD_PB=1u; \
                                         bFM_GPIO_PFRD_PB=0u; }while(0u)


/*---- GPIO bit NPDB ----*/
#define GPIO1PIN_NPDB_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_PB)) )

#define GPIO1PIN_NPDB_PUT(v)         ( bFM_GPIO_PDORD_PB=(uint32_t)(!(v)) )

#define GPIO1PIN_NPDB_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPDB_INITIN(v) \
                                                        : GPIO1PIN_NPDB_INITOUT(v) )

#define GPIO1PIN_NPDB_INITIN(v)      do{ bFM_GPIO_PCRD_PB=(v).bPullup; \
                                         bFM_GPIO_DDRD_PB=0u; \
                                         bFM_GPIO_PFRD_PB=0u; }while(0u)

#define GPIO1PIN_NPDB_INITOUT(v)     do{ bFM_GPIO_PDORD_PB=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_PB=1u; \
                                         bFM_GPIO_PFRD_PB=0u; }while(0u)
...
#define GPIO1PIN_PDC_GET             ( bFM_GPIO_PDIRD_PC )

#define GPIO1PIN_PDC_PUT(v)          ( bFM_GPIO_PDORD_PC=(v) )

#define GPIO1PIN_PDC_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PDC_INITIN(v) \
                                                        : GPIO1PIN_PDC_INITOUT(v) )

#define GPIO1PIN_PDC_INITIN(v)       do{ bFM_GPIO_PCRD_PC=(v).bPullup; \
                                         bFM_GPIO_DDRD_PC=0u; \
                                         bFM_GPIO_PFRD_PC=0u; }while(0u)

#define GPIO1PIN_PDC_INITOUT(v)      do{ bFM_GPIO_PDORD_PC=(v).bInitVal; \
                                         bFM_GPIO_DDRD_PC=1u; \
                                         bFM_GPIO_PFRD_PC=0u; }while(0u)


/*---- GPIO bit NPDC ----*/
#define GPIO1PIN_NPDC_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_PC)) )

#define GPIO1PIN_NPDC_PUT(v)         ( bFM_GPIO_PDORD_PC=(uint32_t)(!(v)) )

#define GPIO1PIN_NPDC_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPDC_INITIN(v) \
                                                        : GPIO1PIN_NPDC_INITOUT(v) )

#define GPIO1PIN_NPDC_INITIN(v)      do{ bFM_GPIO_PCRD_PC=(v).bPullup; \
                                         bFM_GPIO_DDRD_PC=0u; \
                                         bFM_GPIO_PFRD_PC=0u; }while(0u)

#define GPIO1PIN_NPDC_INITOUT(v)     do{ bFM_GPIO_PDORD_PC=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_PC=1u; \
                                         bFM_GPIO_PFRD_PC=0u; }while(0u)
...
#define GPIO1PIN_PDD_GET             ( bFM_GPIO_PDIRD_PD )

#define GPIO1PIN_PDD_PUT(v)          ( bFM_GPIO_PDORD_PD=(v) )

#define GPIO1PIN_PDD_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_PDD_INITIN(v) \
                                                        : GPIO1PIN_PDD_INITOUT(v) )

#define GPIO1PIN_PDD_INITIN(v)       do{ bFM_GPIO_PCRD_PD=(v).bPullup; \
                                         bFM_GPIO_DDRD_PD=0u; \
                                         bFM_GPIO_PFRD_PD=0u; }while(0u)

#define GPIO1PIN_PDD_INITOUT(v)      do{ bFM_GPIO_PDORD_PD=(v).bInitVal; \
                                         bFM_GPIO_DDRD_PD=1u; \
                                         bFM_GPIO_PFRD_PD=0u; }while(0u)


/*---- GPIO bit NPDD ----*/
#define GPIO1PIN_NPDD_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIRD_PD)) )

#define GPIO1PIN_NPDD_PUT(v)         ( bFM_GPIO_PDORD_PD=(uint32_t)(!(v)) )

#define GPIO1PIN_NPDD_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NPDD_INITIN(v) \
                                                        : GPIO1PIN_NPDD_INITOUT(v) )

#define GPIO1PIN_NPDD_INITIN(v)      do{ bFM_GPIO_PCRD_PD=(v).bPullup; \
                                         bFM_GPIO_DDRD_PD=0u; \
                                         bFM_GPIO_PFRD_PD=0u; }while(0u)

#define GPIO1PIN_NPDD_INITOUT(v)     do{ bFM_GPIO_PDORD_PD=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDRD_PD=1u; \
                                         bFM_GPIO_PFRD_PD=0u; }while(0u)
...
/*--- GE_HBCK ---*/
#define SetPinFunc_GE_HBCK(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P0 = 1u; }while(0u)

/*--- GE_HBCSX0 ---*/
#define SetPinFunc_GE_HBCSX0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P1 = 1u; }while(0u)

/*--- GE_HBCSX1 ---*/
#define SetPinFunc_GE_HBCSX1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 4u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_PB = 1u; }while(0u)

/*--- GE_HBDQ0 ---*/
#define SetPinFunc_GE_HBDQ0(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 8u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P2 = 1u; }while(0u)

/*--- GE_HBDQ1 ---*/
#define SetPinFunc_GE_HBDQ1(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P3 = 1u; }while(0u)

/*--- GE_HBDQ2 ---*/
#define SetPinFunc_GE_HBDQ2(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 12u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P4 = 1u; }while(0u)

/*--- GE_HBDQ3 ---*/
#define SetPinFunc_GE_HBDQ3(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 14u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P5 = 1u; }while(0u)

/*--- GE_HBDQ4 ---*/
#define SetPinFunc_GE_HBDQ4(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P6 = 1u; }while(0u)

/*--- GE_HBDQ5 ---*/
#define SetPinFunc_GE_HBDQ5(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P7 = 1u; }while(0u)

/*--- GE_HBDQ6 ---*/
#define SetPinFunc_GE_HBDQ6(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P8 = 1u; }while(0u)

/*--- GE_HBDQ7 ---*/
#define SetPinFunc_GE_HBDQ7(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P9 = 1u; }while(0u)

/*--- GE_HBINTX ---*/
#define SetPinFunc_GE_HBINTX(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 30u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P8 = 1u; }while(0u)

/*--- GE_HBRESETX ---*/
#define SetPinFunc_GE_HBRESETX(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P7 = 1u; }while(0u)

/*--- GE_HBRSTOX ---*/
#define SetPinFunc_GE_HBRSTOX(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 28u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P9 = 1u; }while(0u)

/*--- GE_HBRWDS ---*/
#define SetPinFunc_GE_HBRWDS(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 6u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_PA = 1u; }while(0u)

/*--- GE_HBWPX ---*/
#define SetPinFunc_GE_HBWPX(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR27, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PA = 1u; }while(0u)

/*--- GE_SDA0 ---*/
#define SetPinFunc_GE_SDA0(dummy)            do{ bFM_GPIO_PFRD_P5 = 1u; }while(0u)

/*--- GE_SDA10 ---*/
#define SetPinFunc_GE_SDA10(dummy)           do{ bFM_GPIO_PFRC_P9 = 1u; }while(0u)

/*--- GE_SDA11 ---*/
#define SetPinFunc_GE_SDA11(dummy)           do{ bFM_GPIO_PFRC_P8 = 1u; }while(0u)

/*--- GE_SDA1 ---*/
#define SetPinFunc_GE_SDA1(dummy)            do{ bFM_GPIO_PFRD_P4 = 1u; }while(0u)

/*--- GE_SDA2 ---*/
#define SetPinFunc_GE_SDA2(dummy)            do{ bFM_GPIO_PFRD_P3 = 1u; }while(0u)

/*--- GE_SDA3 ---*/
#define SetPinFunc_GE_SDA3(dummy)            do{ bFM_GPIO_PFRD_P2 = 1u; }while(0u)

/*--- GE_SDA4 ---*/
#define SetPinFunc_GE_SDA4(dummy)            do{ bFM_GPIO_PFRD_P1 = 1u; }while(0u)

/*--- GE_SDA5 ---*/
#define SetPinFunc_GE_SDA5(dummy)            do{ bFM_GPIO_PFRD_P0 = 1u; }while(0u)

/*--- GE_SDA6 ---*/
#define SetPinFunc_GE_SDA6(dummy)            do{ bFM_GPIO_PFRC_PD = 1u; }while(0u)

/*--- GE_SDA7 ---*/
#define SetPinFunc_GE_SDA7(dummy)            do{ bFM_GPIO_PFRC_PC = 1u; }while(0u)

/*--- GE_SDA8 ---*/
#define SetPinFunc_GE_SDA8(dummy)            do{ bFM_GPIO_PFRC_PB = 1u; }while(0u)

/*--- GE_SDA9 ---*/
#define SetPinFunc_GE_SDA9(dummy)            do{ bFM_GPIO_PFRC_PA = 1u; }while(0u)

/*--- GE_SDBA0 ---*/
#define SetPinFunc_GE_SDBA0(dummy)           do{ bFM_GPIO_PFRC_P7 = 1u; }while(0u)

/*--- GE_SDBA1 ---*/
#define SetPinFunc_GE_SDBA1(dummy)           do{ bFM_GPIO_PFRC_P6 = 1u; }while(0u)

/*--- GE_SDCASX ---*/
#define SetPinFunc_GE_SDCASX(dummy)          do{ bFM_GPIO_PFRD_PC = 1u; }while(0u)

/*--- GE_SDCKE ---*/
#define SetPinFunc_GE_SDCKE(dummy)           do{ bFM_GPIO_PFRA_P0 = 1u; }while(0u)

/*--- GE_SDCLK ---*/
#define SetPinFunc_GE_SDCLK(dummy)           do{ bFM_GPIO_PFRA_P1 = 1u; }while(0u)

/*--- GE_SDCSX ---*/
#define SetPinFunc_GE_SDCSX(dummy)           do{ bFM_GPIO_PFRD_PD = 1u; }while(0u)

/*--- GE_SDDQ0 ---*/
#define SetPinFunc_GE_SDDQ0(dummy)           do{ bFM_GPIO_PFRC_P5 = 1u; }while(0u)

/*--- GE_SDDQ10 ---*/
#define SetPinFunc_GE_SDDQ10(dummy)          do{ bFM_GPIO_PFRB_P9 = 1u; }while(0u)

/*--- GE_SDDQ11 ---*/
#define SetPinFunc_GE_SDDQ11(dummy)          do{ bFM_GPIO_PFRB_P8 = 1u; }while(0u)

/*--- GE_SDDQ12 ---*/
#define SetPinFunc_GE_SDDQ12(dummy)          do{ bFM_GPIO_PFRB_P7 = 1u; }while(0u)

/*--- GE_SDDQ13 ---*/
#define SetPinFunc_GE_SDDQ13(dummy)          do{ bFM_GPIO_PFRB_P6 = 1u; }while(0u)

/*--- GE_SDDQ14 ---*/
#define SetPinFunc_GE_SDDQ14(dummy)          do{ bFM_GPIO_PFRB_P5 = 1u; }while(0u)

/*--- GE_SDDQ15 ---*/
#define SetPinFunc_GE_SDDQ15(dummy)          do{ bFM_GPIO_PFRB_P4 = 1u; }while(0u)

/*--- GE_SDDQ16 ---*/
#define SetPinFunc_GE_SDDQ16(dummy)          do{ bFM_GPIO_PFRB_P3 = 1u; }while(0u)

/*--- GE_SDDQ17 ---*/
#define SetPinFunc_GE_SDDQ17(dummy)          do{ bFM_GPIO_PFRB_P2 = 1u; }while(0u)

/*--- GE_SDDQ18 ---*/
#define SetPinFunc_GE_SDDQ18(dummy)          do{ bFM_GPIO_PFRB_P1 = 1u; }while(0u)

/*--- GE_SDDQ19 ---*/
#define SetPinFunc_GE_SDDQ19(dummy)          do{ bFM_GPIO_PFRB_P0 = 1u; }while(0u)

/*--- GE_SDDQ1 ---*/
#define SetPinFunc_GE_SDDQ1(dummy)           do{ bFM_GPIO_PFRC_P4 = 1u; }while(0u)

/*--- GE_SDDQ20 ---*/
#define SetPinFunc_GE_SDDQ20(dummy)          do{ bFM_GPIO_PFRA_P7 = 1u; }while(0u)

/*--- GE_SDDQ21 ---*/
#define SetPinFunc_GE_SDDQ21(dummy)          do{ bFM_GPIO_PFRA_P6 = 1u; }while(0u)

/*--- GE_SDDQ22 ---*/
#define SetPinFunc_GE_SDDQ22(dummy)          do{ bFM_GPIO_PFRA_P5 = 1u; }while(0u)

/*--- GE_SDDQ23 ---*/
#define SetPinFunc_GE_SDDQ23(dummy)          do{ bFM_GPIO_PFRA_P4 = 1u; }while(0u)

/*--- GE_SDDQ24 ---*/
#define SetPinFunc_GE_SDDQ24(dummy)          do{ bFM_GPIO_PFRA_PD = 1u; }while(0u)

/*--- GE_SDDQ25 ---*/
#define SetPinFunc_GE_SDDQ25(dummy)          do{ bFM_GPIO_PFRA_PC = 1u; }while(0u)

/*--- GE_SDDQ26 ---*/
#define SetPinFunc_GE_SDDQ26(dummy)          do{ bFM_GPIO_PFRA_PB = 1u; }while(0u)

/*--- GE_SDDQ27 ---*/
#define SetPinFunc_GE_SDDQ27(dummy)          do{ bFM_GPIO_PFRA_PA = 1u; }while(0u)

/*--- GE_SDDQ28 ---*/
#define SetPinFunc_GE_SDDQ28(dummy)          do{ bFM_GPIO_PFRA_P9 = 1u; }while(0u)

/*--- GE_SDDQ29 ---*/
#define SetPinFunc_GE_SDDQ29(dummy)          do{ bFM_GPIO_PFRA_P8 = 1u; }while(0u)

/*--- GE_SDDQ2 ---*/
#define SetPinFunc_GE_SDDQ2(dummy)           do{ bFM_GPIO_PFRC_P3 = 1u; }while(0u)

/*--- GE_SDDQ30 ---*/
#define SetPinFunc_GE_SDDQ30(dummy)          do{ bFM_GPIO_PFRA_P3 = 1u; }while(0u)

/*--- GE_SDDQ31 ---*/
#define SetPinFunc_GE_SDDQ31(dummy)          do{ bFM_GPIO_PFRA_P2 = 1u; }while(0u)

/*--- GE_SDDQ3 ---*/
#define SetPinFunc_GE_SDDQ3(dummy)           do{ bFM_GPIO_PFRC_P2 = 1u; }while(0u)

/*--- GE_SDDQ4 ---*/
#define SetPinFunc_GE_SDDQ4(dummy)           do{ bFM_GPIO_PFRC_P1 = 1u; }while(0u)

/*--- GE_SDDQ5 ---*/
#define SetPinFunc_GE_SDDQ5(dummy)           do{ bFM_GPIO_PFRC_P0 = 1u; }while(0u)

/*--- GE_SDDQ6 ---*/
#define SetPinFunc_GE_SDDQ6(dummy)           do{ bFM_GPIO_PFRB_PD = 1u; }while(0u)

/*--- GE_SDDQ7 ---*/
#define SetPinFunc_GE_SDDQ7(dummy)           do{ bFM_GPIO_PFRB_PC = 1u; }while(0u)

/*--- GE_SDDQ8 ---*/
#define SetPinFunc_GE_SDDQ8(dummy)           do{ bFM_GPIO_PFRB_PB = 1u; }while(0u)

/*--- GE_SDDQ9 ---*/
#define SetPinFunc_GE_SDDQ9(dummy)           do{ bFM_GPIO_PFRB_PA = 1u; }while(0u)

/*--- GE_SDDQM0 ---*/
#define SetPinFunc_GE_SDDQM0(dummy)          do{ bFM_GPIO_PFRD_P9 = 1u; }while(0u)

/*--- GE_SDDQM1 ---*/
#define SetPinFunc_GE_SDDQM1(dummy)          do{ bFM_GPIO_PFRD_P8 = 1u; }while(0u)

/*--- GE_SDDQM2 ---*/
#define SetPinFunc_GE_SDDQM2(dummy)          do{ bFM_GPIO_PFRD_P7 = 1u; }while(0u)

/*--- GE_SDDQM3 ---*/
#define SetPinFunc_GE_SDDQM3(dummy)          do{ bFM_GPIO_PFRD_P6 = 1u; }while(0u)

/*--- GE_SDRASX ---*/
#define SetPinFunc_GE_SDRASX(dummy)          do{ bFM_GPIO_PFRD_PB = 1u; }while(0u)

/*--- GE_SDWEX ---*/
#define SetPinFunc_GE_SDWEX(dummy)           do{ bFM_GPIO_PFRD_PA = 1u; }while(0u)

/*--- GE_SPCK ---*/
#define SetPinFunc_GE_SPCK(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P0 = 1u; }while(0u)

/*--- GE_SPCSX0 ---*/
#define SetPinFunc_GE_SPCSX0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P3 = 1u; }while(0u)

/*--- GE_SPDQ0 ---*/
#define SetPinFunc_GE_SPDQ0(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P1 = 1u; }while(0u)

/*--- GE_SPDQ1 ---*/
#define SetPinFunc_GE_SPDQ1(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 12u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P4 = 1u; }while(0u)

/*--- GE_SPDQ2 ---*/
#define SetPinFunc_GE_SPDQ2(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 14u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P5 = 1u; }while(0u)

/*--- GE_SPDQ3 ---*/
#define SetPinFunc_GE_SPDQ3(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR26, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_P2 = 1u; }while(0u)

/*--- I2SCK0 ---*/
#define SetPinFunc_I2SCK0(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 4u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PF = 1u; }while(0u)

/*--- I2SCK1 ---*/
#define SetPinFunc_I2SCK1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P5 = 1u; }while(0u)

/*--- I2SDI0 ---*/
#define SetPinFunc_I2SDI0(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 8u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PE = 1u; }while(0u)

/*--- I2SDI1 ---*/
#define SetPinFunc_I2SDI1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P4 = 1u; }while(0u)

/*--- I2SDO0 ---*/
#define SetPinFunc_I2SDO0(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PC = 1u; }while(0u)

/*--- I2SDO1 ---*/
#define SetPinFunc_I2SDO1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P2 = 1u; }while(0u)

/*--- I2SMCLK0_IN ---*/
#define SetPinFunc_I2SMCLK0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PB = 1u; }while(0u)

/*--- I2SMCLK0_OUT ---*/
#define SetPinFunc_I2SMCLK0_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PB = 1u; }while(0u)

/*--- I2SMCLK1_IN ---*/
#define SetPinFunc_I2SMCLK1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P1 = 1u; }while(0u)

/*--- I2SMCLK1_OUT ---*/
#define SetPinFunc_I2SMCLK1_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P1 = 1u; }while(0u)

/*--- I2SWS0 ---*/
#define SetPinFunc_I2SWS0(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 6u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PD = 1u; }while(0u)

/*--- I2SWS1 ---*/
#define SetPinFunc_I2SWS1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR24, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P3 = 1u; }while(0u)
...
/*--- PNL_DCLK ---*/
#define SetPinFunc_PNL_DCLK(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P2 = 1u; }while(0u)

/*--- PNL_DEN ---*/
#define SetPinFunc_PNL_DEN(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 4u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P3 = 1u; }while(0u)

/*--- PNL_FV_SYNC ---*/
#define SetPinFunc_PNL_FV_SYNC(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 8u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P6 = 1u; }while(0u)

/*--- PNL_LE ---*/
#define SetPinFunc_PNL_LE(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 6u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P4 = 1u; }while(0u)

/*--- PNL_LH_SYNC ---*/
#define SetPinFunc_PNL_LH_SYNC(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P5 = 1u; }while(0u)

/*--- PNL_PD0 ---*/
#define SetPinFunc_PNL_PD0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P3 = 1u; }while(0u)

/*--- PNL_PD10 ---*/
#define SetPinFunc_PNL_PD10(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PA = 1u; }while(0u)

/*--- PNL_PD11 ---*/
#define SetPinFunc_PNL_PD11(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_P9 = 1u; }while(0u)

/*--- PNL_PD12 ---*/
#define SetPinFunc_PNL_PD12(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_P8 = 1u; }while(0u)

/*--- PNL_PD13 ---*/
#define SetPinFunc_PNL_PD13(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_P7 = 1u; }while(0u)

/*--- PNL_PD14 ---*/
#define SetPinFunc_PNL_PD14(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 28u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_P6 = 1u; }while(0u)

/*--- PNL_PD15 ---*/
#define SetPinFunc_PNL_PD15(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 30u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_P5 = 1u; }while(0u)

/*--- PNL_PD16 ---*/
#define SetPinFunc_PNL_PD16(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P7 = 1u; \
                                                 bFM_GPIO_ADE_AN23 = 0u; }while(0u)

/*--- PNL_PD17 ---*/
#define SetPinFunc_PNL_PD17(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P6 = 1u; \
                                                 bFM_GPIO_ADE_AN22 = 0u; }while(0u)

/*--- PNL_PD18 ---*/
#define SetPinFunc_PNL_PD18(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 4u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P5 = 1u; \
                                                 bFM_GPIO_ADE_AN21 = 0u; }while(0u)

/*--- PNL_PD19 ---*/
#define SetPinFunc_PNL_PD19(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 6u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P4 = 1u; \
                                                 bFM_GPIO_ADE_AN20 = 0u; }while(0u)

/*--- PNL_PD1 ---*/
#define SetPinFunc_PNL_PD1(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 2u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P4 = 1u; }while(0u)

/*--- PNL_PD20 ---*/
#define SetPinFunc_PNL_PD20(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 8u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P3 = 1u; \
                                                 bFM_GPIO_ADE_AN19 = 0u; }while(0u)

/*--- PNL_PD21 ---*/
#define SetPinFunc_PNL_PD21(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P2 = 1u; \
                                                 bFM_GPIO_ADE_AN18 = 0u; }while(0u)

/*--- PNL_PD22 ---*/
#define SetPinFunc_PNL_PD22(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 12u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P1 = 1u; \
                                                 bFM_GPIO_ADE_AN17 = 0u; }while(0u)

/*--- PNL_PD23 ---*/
#define SetPinFunc_PNL_PD23(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 14u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P0 = 1u; \
                                                 bFM_GPIO_ADE_AN16 = 0u; }while(0u)

/*--- PNL_PD2 ---*/
#define SetPinFunc_PNL_PD2(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 4u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P5 = 1u; }while(0u)

/*--- PNL_PD3 ---*/
#define SetPinFunc_PNL_PD3(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 6u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P6 = 1u; }while(0u)

/*--- PNL_PD4 ---*/
#define SetPinFunc_PNL_PD4(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 8u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P7 = 1u; }while(0u)

/*--- PNL_PD5 ---*/
#define SetPinFunc_PNL_PD5(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 10u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR6_P8 = 1u; }while(0u)

/*--- PNL_PD6 ---*/
#define SetPinFunc_PNL_PD6(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 12u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PE = 1u; }while(0u)

/*--- PNL_PD7 ---*/
#define SetPinFunc_PNL_PD7(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 14u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PD = 1u; }while(0u)

/*--- PNL_PD8 ---*/
#define SetPinFunc_PNL_PD8(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PC = 1u; }while(0u)

/*--- PNL_PD9 ---*/
#define SetPinFunc_PNL_PD9(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR28, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PB = 1u; }while(0u)

/*--- PNL_PWE ---*/
#define SetPinFunc_PNL_PWE(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 0u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P1 = 1u; }while(0u)

/*--- PNL_TSIG0 ---*/
#define SetPinFunc_PNL_TSIG0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P5 = 1u; }while(0u)

/*--- PNL_TSIG10 ---*/
#define SetPinFunc_PNL_TSIG10(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 28u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P1 = 1u; \
                                                 bFM_GPIO_ADE_AN17 = 0u; }while(0u)

/*--- PNL_TSIG11 ---*/
#define SetPinFunc_PNL_TSIG11(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 30u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P0 = 1u; \
                                                 bFM_GPIO_ADE_AN16 = 0u; }while(0u)

/*--- PNL_TSIG1 ---*/
#define SetPinFunc_PNL_TSIG1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P6 = 1u; }while(0u)

/*--- PNL_TSIG2 ---*/
#define SetPinFunc_PNL_TSIG2(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P3 = 1u; }while(0u)

/*--- PNL_TSIG3 ---*/
#define SetPinFunc_PNL_TSIG3(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P4 = 1u; }while(0u)

/*--- PNL_TSIG4 ---*/
#define SetPinFunc_PNL_TSIG4(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR30, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P1 = 1u; }while(0u)

/*--- PNL_TSIG5 ---*/
#define SetPinFunc_PNL_TSIG5(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P6 = 1u; \
                                                 bFM_GPIO_ADE_AN22 = 0u; }while(0u)

/*--- PNL_TSIG6 ---*/
#define SetPinFunc_PNL_TSIG6(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P5 = 1u; \
                                                 bFM_GPIO_ADE_AN21 = 0u; }while(0u)

/*--- PNL_TSIG7 ---*/
#define SetPinFunc_PNL_TSIG7(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P4 = 1u; \
                                                 bFM_GPIO_ADE_AN20 = 0u; }while(0u)

/*--- PNL_TSIG8 ---*/
#define SetPinFunc_PNL_TSIG8(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P3 = 1u; \
                                                 bFM_GPIO_ADE_AN19 = 0u; }while(0u)

/*--- PNL_TSIG9 ---*/
#define SetPinFunc_PNL_TSIG9(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR29, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P2 = 1u; \
                                                 bFM_GPIO_ADE_AN18 = 0u; }while(0u)
...
/*--- S_CD ---*/
#define SetPinFunc_S_CD(dummy)               do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_PA = 1u; }while(0u)

/*--- S_CLK ---*/
#define SetPinFunc_S_CLK(dummy)              do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 14u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P5 = 1u; }while(0u)

/*--- S_CMD ---*/
#define SetPinFunc_S_CMD(dummy)              do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P6 = 1u; }while(0u)

/*--- S_DATA0 ---*/
#define SetPinFunc_S_DATA0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P4 = 1u; }while(0u)

/*--- S_DATA1 ---*/
#define SetPinFunc_S_DATA1(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P3 = 1u; }while(0u)

/*--- S_DATA2 ---*/
#define SetPinFunc_S_DATA2(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P8 = 1u; }while(0u)

/*--- S_DATA3 ---*/
#define SetPinFunc_S_DATA3(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P7 = 1u; }while(0u)

/*--- S_WP ---*/
#define SetPinFunc_S_WP(dummy)               do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR18, 28u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR3_P9 = 1u; }while(0u)
...
#endif // #ifndef __GPIO_S6E2DFXJ_H__
