...
*/
/************************************************************************************/
/** \file gpio_s6e2h1xg.h
 **
 ** Headerfile for S6E2H1XG GPIO functions, included in gpio.h
 **
 ** History:
 **   - 2015-06-23  1.0  EZh    First version
 **
 ******************************************************************************/

#ifndef __GPIO_S6E2H1XG_H__
#define __GPIO_S6E2H1XG_H__
...
/*--- IGTRG0_0 ---*/
#define SetPinFunc_IGTRG0_0(dummy)           do{ }while(0u)

/*--- IGTRG0_1 ---*/
#define SetPinFunc_IGTRG0_1(dummy)           do{ }while(0u)
...
/*--- SCS6_1 ---*/
#define SetPinFunc_SCS6_1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR16, 0u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR0_PE = 1u; }while(0u)

/*--- SCS7_1 ---*/
#define SetPinFunc_SCS7_1(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR16, 2u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR4_PB = 1u; }while(0u)
...
#endif // #ifndef __GPIO_S6E2H1XG_H__
