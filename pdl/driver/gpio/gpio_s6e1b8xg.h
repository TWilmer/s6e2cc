...
*/
/************************************************************************************/
/** \file gpio_s6e1b8xg.h
 **
 ** Headerfile for S6E1B8XG GPIO functions, included in gpio.h
 **
 ** History:
...
#ifndef __GPIO_S6E1B8XG_H__
#define __GPIO_S6E1B8XG_H__
...
#define FGPIO1PIN_P24_INITOUT(v)      do{ FM_FASTIO->FPDOR2_f.P4=(v).bInitVal; \
                                          bFM_GPIO_DDR2_P4=1u; \
                                          bFM_GPIO_PFR2_P4=0u; }while(0)
...
#define FGPIO1PIN_P25_INITOUT(v)      do{ FM_FASTIO->FPDOR2_f.P5=(v).bInitVal; \
                                          bFM_GPIO_DDR2_P5=1u; \
                                          bFM_GPIO_PFR2_P5=0u; }while(0)
...
#define FGPIO1PIN_P26_INITOUT(v)      do{ FM_FASTIO->FPDOR2_f.P6=(v).bInitVal; \
                                          bFM_GPIO_DDR2_P6=1u; \
                                          bFM_GPIO_PFR2_P6=0u; }while(0)
...
#define FGPIO1PIN_P27_INITOUT(v)      do{ FM_FASTIO->FPDOR2_f.P7=(v).bInitVal; \
                                          bFM_GPIO_DDR2_P7=1u; \
                                          bFM_GPIO_PFR2_P7=0u; \
                                          bFM_GPIO_ADE_AN15=0u; }while(0)
...
#define FGPIO1PIN_P28_INITOUT(v)      do{ FM_FASTIO->FPDOR2_f.P8=(v).bInitVal; \
                                          bFM_GPIO_DDR2_P8=1u; \
                                          bFM_GPIO_PFR2_P8=0u; }while(0)
...
#define FGPIO1PIN_P57_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.P7=(v).bInitVal; \
                                          bFM_GPIO_DDR5_P7=1u; \
                                          bFM_GPIO_PFR5_P7=0u; }while(0)
...
#define FGPIO1PIN_P58_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.P8=(v).bInitVal; \
                                          bFM_GPIO_DDR5_P8=1u; \
                                          bFM_GPIO_PFR5_P8=0u; }while(0)
...
#define FGPIO1PIN_P59_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.P9=(v).bInitVal; \
                                          bFM_GPIO_DDR5_P9=1u; \
                                          bFM_GPIO_PFR5_P9=0u; }while(0)
...
#define FGPIO1PIN_P5A_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.PA=(v).bInitVal; \
                                          bFM_GPIO_DDR5_PA=1u; \
                                          bFM_GPIO_PFR5_PA=0u; }while(0)
...
#define FGPIO1PIN_P5B_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.PB=(v).bInitVal; \
                                          bFM_GPIO_DDR5_PB=1u; \
                                          bFM_GPIO_PFR5_PB=0u; }while(0)
...
#define FGPIO1PIN_P64_INITOUT(v)      do{ FM_FASTIO->FPDOR6_f.P4=(v).bInitVal; \
                                          bFM_GPIO_DDR6_P4=1u; \
                                          bFM_GPIO_PFR6_P4=0u; }while(0)
...
#define FGPIO1PIN_P65_INITOUT(v)      do{ FM_FASTIO->FPDOR6_f.P5=(v).bInitVal; \
                                          bFM_GPIO_DDR6_P5=1u; \
                                          bFM_GPIO_PFR6_P5=0u; }while(0)
...
#define FGPIO1PIN_P66_INITOUT(v)      do{ FM_FASTIO->FPDOR6_f.P6=(v).bInitVal; \
                                          bFM_GPIO_DDR6_P6=1u; \
                                          bFM_GPIO_PFR6_P6=0u; }while(0)
...
#define FGPIO1PIN_P67_INITOUT(v)      do{ FM_FASTIO->FPDOR6_f.P7=(v).bInitVal; \
                                          bFM_GPIO_DDR6_P7=1u; \
                                          bFM_GPIO_PFR6_P7=0u; }while(0)
...
#define FGPIO1PIN_P68_INITOUT(v)      do{ FM_FASTIO->FPDOR6_f.P8=(v).bInitVal; \
                                          bFM_GPIO_DDR6_P8=1u; \
                                          bFM_GPIO_PFR6_P8=0u; }while(0)
...
#define FGPIO1PIN_P70_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P0=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P0=1u; \
                                          bFM_GPIO_PFR7_P0=0u; }while(0)
...
#define FGPIO1PIN_P71_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P1=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P1=1u; \
                                          bFM_GPIO_PFR7_P1=0u; }while(0)
...
#define FGPIO1PIN_P72_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P2=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P2=1u; \
                                          bFM_GPIO_PFR7_P2=0u; }while(0)
...
#define FGPIO1PIN_P73_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P3=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P3=1u; \
                                          bFM_GPIO_PFR7_P3=0u; }while(0)
...
#define FGPIO1PIN_P74_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P4=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P4=1u; \
                                          bFM_GPIO_PFR7_P4=0u; }while(0)
...
/*--- COM0 ---*/
#define SetPinFunc_COM0(dummy)               do{ }while(0u)

/*--- COM1 ---*/
#define SetPinFunc_COM1(dummy)               do{ }while(0u)

/*--- COM2 ---*/
#define SetPinFunc_COM2(dummy)               do{ }while(0u)

/*--- COM3 ---*/
#define SetPinFunc_COM3(dummy)               do{ }while(0u)

/*--- COM4 ---*/
#define SetPinFunc_COM4(dummy)               do{ }while(0u)

/*--- COM5 ---*/
#define SetPinFunc_COM5(dummy)               do{ }while(0u)

/*--- COM6 ---*/
#define SetPinFunc_COM6(dummy)               do{ }while(0u)

/*--- COM7 ---*/
#define SetPinFunc_COM7(dummy)               do{ }while(0u)
...
/*--- SEG00 ---*/
#define SetPinFunc_SEG00(dummy)              do{ }while(0u)

/*--- SEG01 ---*/
#define SetPinFunc_SEG01(dummy)              do{ }while(0u)

/*--- SEG02 ---*/
#define SetPinFunc_SEG02(dummy)              do{ }while(0u)

/*--- SEG03 ---*/
#define SetPinFunc_SEG03(dummy)              do{ }while(0u)

/*--- SEG04 ---*/
#define SetPinFunc_SEG04(dummy)              do{ }while(0u)

/*--- SEG05 ---*/
#define SetPinFunc_SEG05(dummy)              do{ }while(0u)

/*--- SEG06 ---*/
#define SetPinFunc_SEG06(dummy)              do{ }while(0u)

/*--- SEG07 ---*/
#define SetPinFunc_SEG07(dummy)              do{ }while(0u)

/*--- SEG08 ---*/
#define SetPinFunc_SEG08(dummy)              do{ }while(0u)

/*--- SEG09 ---*/
#define SetPinFunc_SEG09(dummy)              do{ }while(0u)

/*--- SEG10 ---*/
#define SetPinFunc_SEG10(dummy)              do{ }while(0u)

/*--- SEG11 ---*/
#define SetPinFunc_SEG11(dummy)              do{ }while(0u)

/*--- SEG12 ---*/
#define SetPinFunc_SEG12(dummy)              do{ }while(0u)

/*--- SEG13 ---*/
#define SetPinFunc_SEG13(dummy)              do{ }while(0u)

/*--- SEG14 ---*/
#define SetPinFunc_SEG14(dummy)              do{ }while(0u)

/*--- SEG15 ---*/
#define SetPinFunc_SEG15(dummy)              do{ }while(0u)

/*--- SEG16 ---*/
#define SetPinFunc_SEG16(dummy)              do{ }while(0u)

/*--- SEG17 ---*/
#define SetPinFunc_SEG17(dummy)              do{ }while(0u)

/*--- SEG18 ---*/
#define SetPinFunc_SEG18(dummy)              do{ }while(0u)

/*--- SEG19 ---*/
#define SetPinFunc_SEG19(dummy)              do{ }while(0u)

/*--- SEG20 ---*/
#define SetPinFunc_SEG20(dummy)              do{ }while(0u)

/*--- SEG21 ---*/
#define SetPinFunc_SEG21(dummy)              do{ }while(0u)

/*--- SEG22 ---*/
#define SetPinFunc_SEG22(dummy)              do{ }while(0u)

/*--- SEG23 ---*/
#define SetPinFunc_SEG23(dummy)              do{ }while(0u)

/*--- SEG24 ---*/
#define SetPinFunc_SEG24(dummy)              do{ }while(0u)

/*--- SEG25 ---*/
#define SetPinFunc_SEG25(dummy)              do{ }while(0u)

/*--- SEG26 ---*/
#define SetPinFunc_SEG26(dummy)              do{ }while(0u)

/*--- SEG27 ---*/
#define SetPinFunc_SEG27(dummy)              do{ }while(0u)

/*--- SEG28 ---*/
#define SetPinFunc_SEG28(dummy)              do{ }while(0u)

/*--- SEG29 ---*/
#define SetPinFunc_SEG29(dummy)              do{ }while(0u)

/*--- SEG30 ---*/
#define SetPinFunc_SEG30(dummy)              do{ }while(0u)

/*--- SEG31 ---*/
#define SetPinFunc_SEG31(dummy)              do{ }while(0u)

/*--- SEG32 ---*/
#define SetPinFunc_SEG32(dummy)              do{ }while(0u)

/*--- SEG33 ---*/
#define SetPinFunc_SEG33(dummy)              do{ }while(0u)

/*--- SEG34 ---*/
#define SetPinFunc_SEG34(dummy)              do{ }while(0u)

/*--- SEG35 ---*/
#define SetPinFunc_SEG35(dummy)              do{ }while(0u)

/*--- SEG36 ---*/
#define SetPinFunc_SEG36(dummy)              do{ }while(0u)

/*--- SEG37 ---*/
#define SetPinFunc_SEG37(dummy)              do{ }while(0u)

/*--- SEG38 ---*/
#define SetPinFunc_SEG38(dummy)              do{ }while(0u)

/*--- SEG39 ---*/
#define SetPinFunc_SEG39(dummy)              do{ }while(0u)

/*--- SEG40 ---*/
#define SetPinFunc_SEG40(dummy)              do{ }while(0u)

/*--- SEG41 ---*/
#define SetPinFunc_SEG41(dummy)              do{ }while(0u)

/*--- SEG42 ---*/
#define SetPinFunc_SEG42(dummy)              do{ }while(0u)

/*--- SEG43 ---*/
#define SetPinFunc_SEG43(dummy)              do{ }while(0u)
...
/*--- VV0 ---*/
#define SetPinFunc_VV0(dummy)                do{ }while(0u)

/*--- VV1 ---*/
#define SetPinFunc_VV1(dummy)                do{ }while(0u)

/*--- VV2 ---*/
#define SetPinFunc_VV2(dummy)                do{ }while(0u)

/*--- VV3 ---*/
#define SetPinFunc_VV3(dummy)                do{ }while(0u)

/*--- VV4 ---*/
#define SetPinFunc_VV4(dummy)                do{ }while(0u)
...
#endif // #ifndef __GPIO_S6E1B8XG_H__
