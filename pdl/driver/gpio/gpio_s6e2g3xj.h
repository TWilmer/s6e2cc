...
*/
/************************************************************************************/
/** \file gpio_s6e2g3xj.h
 **
 ** Headerfile for S6E2G3XJ GPIO functions, included in gpio.h
 **
 ** History:
 **   - 2015-04-15  1.0  EZh    First version
 **
 ******************************************************************************/

#ifndef __GPIO_S6E2G3XJ_H__
#define __GPIO_S6E2G3XJ_H__
...
/*--- MI2SCK1_0 ---*/
#define SetPinFunc_MI2SCK1_0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_PA = 1u; }while(0u)

/*--- MI2SCK1_1 ---*/
#define SetPinFunc_MI2SCK1_1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 20u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR5_PF = 1u; }while(0u)

/*--- MI2SDI1_0 ---*/
#define SetPinFunc_MI2SDI1_0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_P8 = 1u; }while(0u)

/*--- MI2SDI1_1 ---*/
#define SetPinFunc_MI2SDI1_1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 24u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR5_PD = 1u; }while(0u)

/*--- MI2SDO1_0 ---*/
#define SetPinFunc_MI2SDO1_0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_P9 = 1u; }while(0u)

/*--- MI2SDO1_1 ---*/
#define SetPinFunc_MI2SDO1_1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 26u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR5_PE = 1u; }while(0u)

/*--- MI2SMCK1_0_IN ---*/
#define SetPinFunc_MI2SMCK1_0_IN(dummy)      do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 16u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_PC = 1u; }while(0u)

/*--- MI2SMCK1_0_OUT ---*/
#define SetPinFunc_MI2SMCK1_0_OUT(dummy)     do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_PC = 1u; }while(0u)

/*--- MI2SMCK1_1_IN ---*/
#define SetPinFunc_MI2SMCK1_1_IN(dummy)      do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 16u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P1 = 1u; }while(0u)

/*--- MI2SMCK1_1_OUT ---*/
#define SetPinFunc_MI2SMCK1_1_OUT(dummy)     do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 18u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P1 = 1u; }while(0u)

/*--- MI2SWS1_0 ---*/
#define SetPinFunc_MI2SWS1_0(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 22u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR4_PB = 1u; }while(0u)

/*--- MI2SWS1_1 ---*/
#define SetPinFunc_MI2SWS1_1(dummy)          do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 22u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P0 = 1u; }while(0u)
...
#endif // #ifndef __GPIO_S6E2G3XJ_H__
