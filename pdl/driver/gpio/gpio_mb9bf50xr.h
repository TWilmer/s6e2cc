...
*/
/************************************************************************************/
/** \file gpio_mb9bf50xr.h 
 **
 ** Headerfile for MB9BF50XR GPIO functions, included in gpio.h
 **
 ** History:
...
#ifndef __GPIO_MB9BF50XR_H__
#define __GPIO_MB9BF50XR_H__
...
/*--- MCSX4 ---*/
#define SetPinFunc_MCSX4(dummy)              do{ bFM_GPIO_EPFR10_UECS4E = 1; \
                                                 bFM_GPIO_PFR2_P6 = 1u; }while(0)

/*--- MCSX5 ---*/
#define SetPinFunc_MCSX5(dummy)              do{ bFM_GPIO_EPFR10_UECS5E = 1; \
                                                 bFM_GPIO_PFR2_P7 = 1u; }while(0)

/*--- MCSX6 ---*/
#define SetPinFunc_MCSX6(dummy)              do{ bFM_GPIO_EPFR10_UECS6E = 1; \
                                                 bFM_GPIO_PFR2_P8 = 1u; }while(0)
...
/*--- MNALE ---*/
#define SetPinFunc_MNALE(dummy)              do{ bFM_GPIO_EPFR10_UEFLSE = 1; \
                                                 bFM_GPIO_PFR5_P7 = 1u; }while(0)

/*--- MNCLE ---*/
#define SetPinFunc_MNCLE(dummy)              do{ bFM_GPIO_EPFR10_UEFLSE = 1; \
                                                 bFM_GPIO_PFR5_P8 = 1u; }while(0)

/*--- MNREX ---*/
#define SetPinFunc_MNREX(dummy)              do{ bFM_GPIO_EPFR10_UEFLSE = 1; \
                                                 bFM_GPIO_PFR5_PA = 1u; }while(0)

/*--- MNWEX ---*/
#define SetPinFunc_MNWEX(dummy)              do{ bFM_GPIO_EPFR10_UEFLSE = 1; \
                                                 bFM_GPIO_PFR5_P9 = 1u; }while(0)
...
#endif // #ifndef __GPIO_MB9BF50XR_H__
