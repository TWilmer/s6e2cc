...
*/
/************************************************************************************/
/** \file gpio_s6e100xf.h
 **
 ** Headerfile for S6E100XF GPIO functions, included in gpio.h
 **
 ** History:
...
#ifndef __GPIO_S6E100XF_H__
#define __GPIO_S6E100XF_H__
...
#define FGPIO1PIN_P49_INITIN(v)       do{ bFM_GPIO_PCR4_P9=(v).bPullup; \
                                          bFM_GPIO_DDR4_P9=0u; \
...
#define FGPIO1PIN_NP49_INITIN(v)      do{ bFM_GPIO_PCR4_P9=(v).bPullup; \
                                          bFM_GPIO_DDR4_P9=0u; \
                                          bFM_GPIO_PFR4_P9=0u; }while(0)

#define FGPIO1PIN_NP49_INITOUT(v)     do{ bFM_GPIO_PDOR4_P9=(uint8_t)(!((uint8_t)(v).bInitVal)); \
                                          bFM_GPIO_DDR4_P9=1u; \
                                          bFM_GPIO_PFR4_P9=0u; }while(0)
...
#define FGPIO1PIN_P5C_GET             ( FM_FASTIO->FPDIR5_f.PC )

#define FGPIO1PIN_P5C_PUT(v)          ( FM_FASTIO->FPDOR5_f.PC=(v) )

#define FGPIO1PIN_P5C_INIT(v)         ( (0==(v).bOutput) ? FGPIO1PIN_P5C_INITIN(v) \
                                                         : FGPIO1PIN_P5C_INITOUT(v) )

#define FGPIO1PIN_P5C_INITIN(v)       do{ bFM_GPIO_PCR5_PC=(v).bPullup; \
                                          bFM_GPIO_DDR5_PC=0u; \
                                          bFM_GPIO_PFR5_PC=0u; }while(0)

#define FGPIO1PIN_P5C_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.PC=(v).bInitVal; \
                                          bFM_GPIO_DDR5_PC=1u; \
                                          bFM_GPIO_PFR5_PC=0u; }while(0)


/*---- Fast GPIO bit NP5C ----*/
#define FGPIO1PIN_NP5C_GET            ( (uint8_t)(!(FM_FASTIO->FPDIR5_f.PC)) )

#define FGPIO1PIN_NP5C_PUT(v)         ( FM_FASTIO->FPDOR5_f.PC=(uint8_t)(!(v)) )

#define FGPIO1PIN_NP5C_INIT(v)        ( (0==(v).bOutput) ? FGPIO1PIN_NP5C_INITIN(v) \
                                                         : FGPIO1PIN_NP5C_INITOUT(v) )

#define FGPIO1PIN_NP5C_INITIN(v)      do{ bFM_GPIO_PCR5_PC=(v).bPullup; \
                                          bFM_GPIO_DDR5_PC=0u; \
                                          bFM_GPIO_PFR5_PC=0u; }while(0)

#define FGPIO1PIN_NP5C_INITOUT(v)     do{ bFM_GPIO_PDOR5_PC=(uint8_t)(!((uint8_t)(v).bInitVal)); \
                                          bFM_GPIO_DDR5_PC=1u; \
                                          bFM_GPIO_PFR5_PC=0u; }while(0)
...
#define FGPIO1PIN_P5D_GET             ( FM_FASTIO->FPDIR5_f.PD )

#define FGPIO1PIN_P5D_PUT(v)          ( FM_FASTIO->FPDOR5_f.PD=(v) )

#define FGPIO1PIN_P5D_INIT(v)         ( (0==(v).bOutput) ? FGPIO1PIN_P5D_INITIN(v) \
                                                         : FGPIO1PIN_P5D_INITOUT(v) )

#define FGPIO1PIN_P5D_INITIN(v)       do{ bFM_GPIO_PCR5_PD=(v).bPullup; \
                                          bFM_GPIO_DDR5_PD=0u; \
                                          bFM_GPIO_PFR5_PD=0u; }while(0)

#define FGPIO1PIN_P5D_INITOUT(v)      do{ FM_FASTIO->FPDOR5_f.PD=(v).bInitVal; \
                                          bFM_GPIO_DDR5_PD=1u; \
                                          bFM_GPIO_PFR5_PD=0u; }while(0)


/*---- Fast GPIO bit NP5D ----*/
#define FGPIO1PIN_NP5D_GET            ( (uint8_t)(!(FM_FASTIO->FPDIR5_f.PD)) )

#define FGPIO1PIN_NP5D_PUT(v)         ( FM_FASTIO->FPDOR5_f.PD=(uint8_t)(!(v)) )

#define FGPIO1PIN_NP5D_INIT(v)        ( (0==(v).bOutput) ? FGPIO1PIN_NP5D_INITIN(v) \
                                                         : FGPIO1PIN_NP5D_INITOUT(v) )

#define FGPIO1PIN_NP5D_INITIN(v)      do{ bFM_GPIO_PCR5_PD=(v).bPullup; \
                                          bFM_GPIO_DDR5_PD=0u; \
                                          bFM_GPIO_PFR5_PD=0u; }while(0)

#define FGPIO1PIN_NP5D_INITOUT(v)     do{ bFM_GPIO_PDOR5_PD=(uint8_t)(!((uint8_t)(v).bInitVal)); \
                                          bFM_GPIO_DDR5_PD=1u; \
                                          bFM_GPIO_PFR5_PD=0u; }while(0)
...
#define FGPIO1PIN_P75_GET             ( FM_FASTIO->FPDIR7_f.P5 )

#define FGPIO1PIN_P75_PUT(v)          ( FM_FASTIO->FPDOR7_f.P5=(v) )

#define FGPIO1PIN_P75_INIT(v)         ( (0==(v).bOutput) ? FGPIO1PIN_P75_INITIN(v) \
                                                         : FGPIO1PIN_P75_INITOUT(v) )

#define FGPIO1PIN_P75_INITIN(v)       do{ bFM_GPIO_PCR7_P5=(v).bPullup; \
                                          bFM_GPIO_DDR7_P5=0u; \
                                          bFM_GPIO_PFR7_P5=0u; }while(0)

#define FGPIO1PIN_P75_INITOUT(v)      do{ FM_FASTIO->FPDOR7_f.P5=(v).bInitVal; \
                                          bFM_GPIO_DDR7_P5=1u; \
                                          bFM_GPIO_PFR7_P5=0u; }while(0)


/*---- Fast GPIO bit NP75 ----*/
#define FGPIO1PIN_NP75_GET            ( (uint8_t)(!(FM_FASTIO->FPDIR7_f.P5)) )

#define FGPIO1PIN_NP75_PUT(v)         ( FM_FASTIO->FPDOR7_f.P5=(uint8_t)(!(v)) )

#define FGPIO1PIN_NP75_INIT(v)        ( (0==(v).bOutput) ? FGPIO1PIN_NP75_INITIN(v) \
                                                         : FGPIO1PIN_NP75_INITOUT(v) )

#define FGPIO1PIN_NP75_INITIN(v)      do{ bFM_GPIO_PCR7_P5=(v).bPullup; \
                                          bFM_GPIO_DDR7_P5=0u; \
                                          bFM_GPIO_PFR7_P5=0u; }while(0)

#define FGPIO1PIN_NP75_INITOUT(v)     do{ bFM_GPIO_PDOR7_P5=(uint8_t)(!((uint8_t)(v).bInitVal)); \
                                          bFM_GPIO_DDR7_P5=1u; \
                                          bFM_GPIO_PFR7_P5=0u; }while(0)
...
/*--- VWAKEUP ---*/
#define SetPinFunc_VWAKEUP(dummy)            do{ }while(0u)
...
#endif // #ifndef __GPIO_S6E100XF_H__
