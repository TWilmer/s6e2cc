...
*/
/************************************************************************************/
/** \file gpio_mb9af15xr.h 
 **
 ** Headerfile for MB9AF15XR GPIO functions, included in gpio.h
 **
 ** History:
...
#ifndef __GPIO_MB9AF15XR_H__
#define __GPIO_MB9AF15XR_H__
...
/*--- TIOB8_0_IN ---*/
#define SetPinFunc_TIOB8_0_IN(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P0 = 1u; }while(0)

/*--- TIOB8_1_IN ---*/
#define SetPinFunc_TIOB8_1_IN(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u, 0x02u ); \
                                                 bFM_GPIO_PFR1_P1 = 1u; \
                                                 bFM_GPIO_ADE_AN01 = 0u; }while(0)

/*--- TIOB8_2_IN ---*/
#define SetPinFunc_TIOB8_2_IN(dummy)         do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u, 0x03u ); \
                                                 bFM_GPIO_PFR3_P9 = 1u; }while(0)
...
#endif // #ifndef __GPIO_MB9AF15XR_H__
