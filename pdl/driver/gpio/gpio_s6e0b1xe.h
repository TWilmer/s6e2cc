...
*/
/************************************************************************************/
/** \file gpio_s6e0b1xe.h 
 **
 ** Headerfile for S6E0B1XE GPIO functions, included in gpio.h
 **
 ** History:
 **   - 2014-02-03  1.0  Ken Xiao    First version
 **
 ******************************************************************************/

#ifndef __GPIO_S6E0B1XE_H__
#define __GPIO_S6E0B1XE_H__
...
/*--- SCSI0_0 ---*/
#define SetPinFunc_SCSI0_0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR07, 28u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P0 = 1u; }while(0)

/*--- SCSI4_2 ---*/
#define SetPinFunc_SCSI4_2(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR07, 29u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PA = 1u; }while(0)

/*--- SCSI5_0 ---*/
#define SetPinFunc_SCSI5_0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR07, 30u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P6 = 1u; }while(0)

/*--- SCSO0_0 ---*/
#define SetPinFunc_SCSO0_0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 28u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR2_P0 = 1u; }while(0)

/*--- SCSO4_2 ---*/
#define SetPinFunc_SCSO4_2(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 29u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR0_PA = 1u; }while(0)

/*--- SCSO5_0 ---*/
#define SetPinFunc_SCSO5_0(dummy)            do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 30u, 1u, 0x01u ); \
                                                 bFM_GPIO_PFR5_P6 = 1u; }while(0)
...
#endif // #ifndef __GPIO_S6E0B1XE_H__
