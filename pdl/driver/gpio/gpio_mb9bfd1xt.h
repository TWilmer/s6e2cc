...
*/
/************************************************************************************/
/** \file gpio_mb9bfd1xt.h 
 **
 ** Headerfile for MB9BFD1XT GPIO functions, included in gpio.h
 **
 ** History:
...
#ifndef __GPIO_MB9BFD1XT_H__
#define __GPIO_MB9BFD1XT_H__
...
#define GPIO1PIN_P7F_GET             ( bFM_GPIO_PDIR7_PF )

#define GPIO1PIN_P7F_PUT(v)          ( bFM_GPIO_PDOR7_PF=(v) )

#define GPIO1PIN_P7F_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P7F_INITIN(v) \
                                                        : GPIO1PIN_P7F_INITOUT(v) )

#define GPIO1PIN_P7F_INITIN(v)       do{ bFM_GPIO_PCR7_PF=(v).bPullup; \
                                         bFM_GPIO_DDR7_PF=0u; \
                                         bFM_GPIO_PFR7_PF=0u; }while(0)

#define GPIO1PIN_P7F_INITOUT(v)      do{ bFM_GPIO_PDOR7_PF=(v).bInitVal; \
                                         bFM_GPIO_DDR7_PF=1u; \
                                         bFM_GPIO_PFR7_PF=0u; }while(0)


/*---- GPIO bit NP7F ----*/
#define GPIO1PIN_NP7F_GET            ( (uint32_t)(!(uint32_t)(bFM_GPIO_PDIR7_PF)) )

#define GPIO1PIN_NP7F_PUT(v)         ( bFM_GPIO_PDOR7_PF=(uint32_t)(!(v)) )

#define GPIO1PIN_NP7F_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP7F_INITIN(v) \
                                                        : GPIO1PIN_NP7F_INITOUT(v) )

#define GPIO1PIN_NP7F_INITIN(v)      do{ bFM_GPIO_PCR7_PF=(v).bPullup; \
                                         bFM_GPIO_DDR7_PF=0u; \
                                         bFM_GPIO_PFR7_PF=0u; }while(0)

#define GPIO1PIN_NP7F_INITOUT(v)     do{ bFM_GPIO_PDOR7_PF=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                         bFM_GPIO_DDR7_PF=1u; \
                                         bFM_GPIO_PFR7_PF=0u; }while(0)
...
#define SetPinFunc_DTTI2X_1(dummy)           do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR03, 16u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR5_PD = 1u; }while(0)

/*--- E_COUT ---*/
#define SetPinFunc_E_COUT(dummy)             do{ bFM_GPIO_EPFR14_E_CKE = 1; \
                                                 bFM_GPIO_PFRC_PB = 1u; }while(0)

/*--- E_MDC0 ---*/
#define SetPinFunc_E_MDC0(dummy)             do{ bFM_GPIO_EPFR22_E_MC0E = 1; \
                                                 bFM_GPIO_PFRC_P7 = 1u; }while(0)

/*--- E_MDIO0 ---*/
#define SetPinFunc_E_MDIO0(dummy)            do{ bFM_GPIO_EPFR14_E_MD0B = 1; \
                                                 bFM_GPIO_PFRC_P6 = 1u; }while(0)

/*--- E_MDIO1 ---*/
#define SetPinFunc_E_MDIO1(dummy)            do{ bFM_GPIO_EPFR14_E_MD1B = 1; \
                                                 bFM_GPIO_PFRC_PC = 1u; }while(0)

/*--- E_PPS0_PPS1 ---*/
#define SetPinFunc_E_PPS0_PPS1(dummy)        do{ bFM_GPIO_EPFR14_E_PSE = 1; \
                                                 bFM_GPIO_PFR6_P2 = 1u; }while(0)

/*--- E_TCK0_MDC1 ---*/
#define SetPinFunc_E_TCK0_MDC1(dummy)        do{ bFM_GPIO_EPFR23_E_MC1B = 1; \
                                                 bFM_GPIO_PFRC_PD = 1u; }while(0)

/*--- E_TX00 ---*/
#define SetPinFunc_E_TX00(dummy)             do{ bFM_GPIO_EPFR14_E_TD0E = 1; \
                                                 bFM_GPIO_PFRD_P2 = 1u; }while(0)

/*--- E_TX01 ---*/
#define SetPinFunc_E_TX01(dummy)             do{ bFM_GPIO_EPFR14_E_TD0E = 1; \
                                                 bFM_GPIO_PFRD_P1 = 1u; }while(0)

/*--- E_TX02_TX10 ---*/
#define SetPinFunc_E_TX02_TX10(dummy)        do{ bFM_GPIO_EPFR14_E_TD1E = 1; \
                                                 bFM_GPIO_PFRD_P0 = 1u; }while(0)

/*--- E_TX03_TX11 ---*/
#define SetPinFunc_E_TX03_TX11(dummy)        do{ bFM_GPIO_EPFR14_E_TD1E = 1; \
                                                 bFM_GPIO_PFRC_PF = 1u; }while(0)

/*--- E_TXEN0 ---*/
#define SetPinFunc_E_TXEN0(dummy)            do{ bFM_GPIO_EPFR14_E_TE0E = 1; \
                                                 bFM_GPIO_PFRD_P3 = 1u; }while(0)

/*--- E_TXER0_TXEN1 ---*/
#define SetPinFunc_E_TXER0_TXEN1(dummy)      do{ bFM_GPIO_EPFR14_E_TE1E = 1; \
...
/*--- SIN6_2 ---*/
#define SetPinFunc_SIN6_2(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 16u, 2u, 0x03u ); \
                                                 bFM_GPIO_PFRF_P3 = 1u; }while(0)
...
/*--- SOT6_2 ---*/
#define SetPinFunc_SOT6_2(dummy)             do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 18u, 2u, 0x03u ); \
                                                 bFM_GPIO_PFRF_P4 = 1u; }while(0)
...
/*--- TIOA06_0_OUT ---*/
#define SetPinFunc_TIOA06_0_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 18u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFRF_P3 = 1u; }while(0)
...
/*--- TIOA06_2_OUT ---*/
#define SetPinFunc_TIOA06_2_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 18u, 2u, 0x03u ); \
                                                 bFM_GPIO_PFR5_PC = 1u; }while(0)

/*--- TIOA07_0_IN ---*/
#define SetPinFunc_TIOA07_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 24u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_PC = 1u; }while(0)

/*--- TIOA07_0_OUT ---*/
#define SetPinFunc_TIOA07_0_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 26u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_PC = 1u; }while(0)
...
/*--- TIOA08_1_OUT ---*/
#define SetPinFunc_TIOA08_1_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 2u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFRF_P1 = 1u; }while(0)
...
/*--- TIOA09_1_IN ---*/
#define SetPinFunc_TIOA09_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 8u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFRB_P0 = 1u; \
                                                 bFM_GPIO_ADE_AN16 = 0u; }while(0)

/*--- TIOA09_1_OUT ---*/
#define SetPinFunc_TIOA09_1_OUT(dummy)       do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 10u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFRB_P0 = 1u; \
                                                 bFM_GPIO_ADE_AN16 = 0u; }while(0)
...
/*--- TIOB00_1_IN ---*/
#define SetPinFunc_TIOB00_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR04, 4u, 3u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P0 = 1u; }while(0)
...
/*--- TIOB01_1_IN ---*/
#define SetPinFunc_TIOB01_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR04, 12u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P1 = 1u; }while(0)
...
/*--- TIOB02_1_IN ---*/
#define SetPinFunc_TIOB02_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR04, 20u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P2 = 1u; }while(0)
...
/*--- TIOB03_1_IN ---*/
#define SetPinFunc_TIOB03_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR04, 28u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P3 = 1u; }while(0)
...
/*--- TIOB04_1_IN ---*/
#define SetPinFunc_TIOB04_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 4u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P4 = 1u; }while(0)
...
/*--- TIOB05_1_IN ---*/
#define SetPinFunc_TIOB05_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 12u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFR3_P5 = 1u; }while(0)
...
/*--- TIOB06_0_IN ---*/
#define SetPinFunc_TIOB06_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 20u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFRF_P4 = 1u; }while(0)
...
/*--- TIOB06_2_IN ---*/
#define SetPinFunc_TIOB06_2_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 20u, 2u, 0x03u ); \
                                                 bFM_GPIO_PFR5_PD = 1u; }while(0)

/*--- TIOB07_0_IN ---*/
#define SetPinFunc_TIOB07_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 28u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR7_PB = 1u; }while(0)
...
/*--- TIOB08_0_IN ---*/
#define SetPinFunc_TIOB08_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P0 = 1u; }while(0)

/*--- TIOB08_1_IN ---*/
#define SetPinFunc_TIOB08_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u, 0x02u ); \
                                                 bFM_GPIO_PFRF_P2 = 1u; }while(0)
...
/*--- TIOB09_0_IN ---*/
#define SetPinFunc_TIOB09_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 12u, 2u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P1 = 1u; }while(0)

/*--- TIOB09_1_IN ---*/
#define SetPinFunc_TIOB09_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 12u, 2u, 0x02u ); \
                                                 bFM_GPIO_PFRB_P1 = 1u; \
                                                 bFM_GPIO_ADE_AN17 = 0u; }while(0)
...
/*--- TIOB12_0_IN ---*/
#define SetPinFunc_TIOB12_0_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR13, 4u, 3u, 0x01u ); \
                                                 bFM_GPIO_PFR9_P4 = 1u; }while(0)

/*--- TIOB12_1_IN ---*/
#define SetPinFunc_TIOB12_1_IN(dummy)        do{ PINRELOC_SET_EPFR( FM_GPIO->EPFR13, 4u, 3u, 0x02u ); \
                                                 bFM_GPIO_PFRB_P7 = 1u; \
                                                 bFM_GPIO_ADE_AN23 = 0u; }while(0)
...
/*--- AN27 ---*/
#define SetPinFunc_AN27(dummy)               ( bFM_GPIO_ADE_AN27 = 1 )

/*--- AN28 ---*/
#define SetPinFunc_AN28(dummy)               ( bFM_GPIO_ADE_AN28 = 1 )

/*--- AN29 ---*/
#define SetPinFunc_AN29(dummy)               ( bFM_GPIO_ADE_AN29 = 1 )

/*--- AN30 ---*/
#define SetPinFunc_AN30(dummy)               ( bFM_GPIO_ADE_AN30 = 1 )

/*--- AN31 ---*/
#define SetPinFunc_AN31(dummy)               ( bFM_GPIO_ADE_AN31 = 1 )


#endif // #ifndef __GPIO_MB9BFD1XT_H__
