...
/** \file hsspi.h
 **
 ** Header file for HS-SPI functions
 **
 ** History:
 ** - 2014-11-13  1.0  MWi  First version
 **
 *****************************************************************************/
...
/**
 *****************************************************************************
 ** \defgroup HsSpiGroup High Speed Quad Serial Peripheral Interface (HSSPI)
 **
 ...
 ** - HsSpi_DirectModeTransferHalfDuplex()
 ** - HsSpi_DirectModeTransferHalfDuplexList()
 ** - HsSpi_SetReadCommandSequence()
 ** - HsSpi_SetWriteCommandSequence()
 ** - HsSpi_MultiModeTransfer()
 **
 ** This module covers functionality for all HS-SPI modules including the command
 ** sequencer mode.
 ** It supports the direct master mode for setting up the external device and
 ** command sequencer mode to read/write to memory devices attached to a HS-SPI
 ** peripheral.
 **
 ** Direct slave mode is not supported.
 **
 ** Standard initialization flow:
 ** - HsSpi_Init() (Direct mode is initially set after init.)
 ** - HsSpi_SetExternalDeviceConfig() (Multiple times, up to 4 devices possible.)
 ** - HsSpi_SetMode() (To change between direct and command sequencer mode.)
 ** - HsSpi_DirectModeTransferHalfDuplex()
 ** - HsSpi_DirectModeTransferHalfDuplexList()
 ** - HsSpi_MultiModeTransfer()
 ** - HsSpi_SetReadCommandSequence();
