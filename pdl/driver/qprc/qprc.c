                            ...
                            stc_qprc_config_t*  pstcConfig )
{
    ...
    {
        case QprcBinDisable: // Disables edge detection
            pstcQprc->QCRH_f.AES = 0u;
            break;
        case QprcBinFallingEdge: // BIN active at falling edge
            pstcQprc->QCRH_f.AES = 1u;
            break;
        case QprcBinRisingEdge: // BIN active at rising edge
            pstcQprc->QCRH_f.AES = 2u;
            break;
        case QprcBinBothEdges: // BIN active at falling or rising edge
            pstcQprc->QCRH_f.AES = 3u;
            break;
        default:
            return ErrorInvalidParameter;
    }
    ...
    switch (pstcConfig->enPcResetMask)
    {
        case QprcResetMaskDisable: // No reset mask
            pstcQprc->QCRH_f.PCRM = 0u;
            break;
        case QprcResetMask2Times:
            pstcQprc->QCRH_f.PCRM = 1u;
            break;
        case QprcResetMask4Times:
            pstcQprc->QCRH_f.PCRM = 2u;
            break;
        case QprcResetMask8Times:
            pstcQprc->QCRH_f.PCRM = 3u;
            break;
        default:
            return ErrorInvalidParameter;
    }
    ...
    pstcQprcNoiseFilter->NFRCTLZ_f.ZINMD = (TRUE == pstcConfig->stcCinFilter.bInputMask) ? 1u : 0u ;
    pstcQprcNoiseFilter->NFRCTLZ_f.ZINLV = (TRUE == pstcConfig->stcCinFilter.bInputInvert) ? 1u : 0u ;
    switch (pstcConfig->stcCinFilter.enWidth)
    {
        case QprcNoFilter:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 0u;
            break;
        case QprcFilterWidth4Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 1u;
            break;
        case QprcFilterWidth8Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 2u;
            break;
        case QprcFilterWidth16Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 3u;
            break;
        case QprcFilterWidth32Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 4u;
            break;
        case QprcFilterWidth64Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 5u;
            break;
        case QprcFilterWidth128Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 6u;
            break;
        case QprcFilterWidth256Pclk:
            pstcQprcNoiseFilter->NFRCTLZ_f.ZINNWS = 7u;
            break;
        default:
            return ErrorInvalidParameter;
    }
...
en_result_t Qprc_DeInit( volatile stc_qprcn_t* pstcQprc, boolean_t bTouchNvic )
{
    ...
    pstcQprcNoiseFilter->NFRCTLZ = 0u;
#endif     
