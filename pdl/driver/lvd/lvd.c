...
en_result_t Lvd_Init(stc_lvd_config_t* pstcConfig)
{
    ...
    stc_lvd_lvd_ctl_field_t  stcLVD_CTL = {0};   
#if (PDL_MCU_TYPE == PDL_FM0P_TYPE2)    
    stc_lvd_lvd_ctl2_field_t stcLVD_CTL2 = {0};
    stc_lvd_lvd2_ctl_field_t  stcLVD2_CTL = {0};   
    stc_lvd_lvd2_ctl2_field_t stcLVD2_CTL2 = {0};
#endif
