...
void SystemCoreClockUpdate (void) {
  ...
  //   "Unordered accesses to a volatile location"
      u32RegisterRead = (__CLKMO  * (((uint32_t)(FM_CRG->PLL_CTL2) & 0x1Fu) + 1u));
...
void SystemInit (void) {
  ...
  if (SCM_CTL_Val & (1ul << 1u)) {                 /* Main clock oscillator enabled ? */
    ...
    while (((FM_CRG->SCM_STR) & (uint8_t)(1ul << 1u)) != (uint8_t)(1ul << 1u)) /* wait for Main clock oscillation stable */
    {}
  }
  ...
  if (SCM_CTL_Val & (1ul << 3))                     /* Sub clock oscillator enabled ? */
  {
    ...
    while ((FM_CRG->SCM_STR & (uint8_t)(1ul << 3)) != (uint8_t)(1ul << 3))       // wait for Sub clock oscillation stable
    {}
  }
  ...
  if (SCM_CTL_Val &  (uint8_t)(1ul << 4u)) {                 // PLL enabled?
    ...
    while ((FM_CRG->SCM_STR &  (uint8_t)(1ul << 4u)) != (uint8_t)(1ul << 4u))      // wait for PLL stable
    {}
  }
  ...
  if ((SCM_CTL_Val & 1u) != 1u) {             /* High-speed CR oscillator disabled ? */
    FM_CRG->SCM_CTL &= (uint8_t)(~1ul);      /* disable High-speed CR oscillator */
  }
  ...
  if( 0x000003FFu != (FM_FLASH_IF->CRTRMM & 0x000003FFu) )
  {
    ...
    /* Set MCR_TTRM */
    FM_CRTRIM->MCR_TTRM = (uint16_t)(FM_FLASH_IF->CRTRMM >> 16u);
    /* Lock (MCR_FTRM) */
